...
public static jobject createJavaFrameSequence(JNIEnv* env, FrameSequence* frameSequence) {
    if (!frameSequence) {
        return NULL;
    }
...
public static jobject nativeDecodeByteArray(JNIEnv* env, jobject clazz,
...
public static jobject nativeDecodeByteBuffer(JNIEnv* env, jobject clazz,
...
public static jobject nativeDecodeStream(JNIEnv* env, jobject clazz,
...
public static void nativeDestroyFrameSequence(JNIEnv* env, jobject clazz,
...
public static jlong nativeCreateState(JNIEnv* env, jobject clazz, jlong frameSequenceLong) {
    FrameSequence* frameSequence = reinterpret_cast<FrameSequence*>(frameSequenceLong);
...
public static void nativeDestroyState(
...
public static jlong JNICALL nativeGetFrame(
...
public static JNINativeMethod gMethods[] = {
