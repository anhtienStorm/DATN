...
public class ProfileAndContactsLoader extends CursorLoader {
    ...
    /*private*/protected String[] mProjection;
    ...
    public Cursor loadInBackground() {
        ...
        //AnhNDd: them con tro query
        addCursorFrequentAndCursorStarred(cursors);
    ...
    /**
     * AnhNDd: thực hiện query các số thường xuyên được liên hệ.
     *
     * @return
     */
    ...
    /**
     * AnhNDd: Thực hiện query các số điện thoại yêu thích.
     *
     * @return
     */
    ...
    public void addCursorFrequentAndCursorStarred(List<Cursor> cursors) {
        //AnhNDd: add thêm số điện thoại thường xuyên liên hệ
        // Anhdts bo danh sach thuong xuyen lien he
//        Cursor cursorFrequent = loadFrequentContacts();
//        if(cursorFrequent!=null){
//            cursors.add(cursorFrequent);
//        }
        //AnhNDd: thuc hien add them so dien thoai yêu thích.
        Cursor cursorStarred = loadStarredContacts();
        if (cursorStarred != null) {
            cursors.add(cursorStarred);
        }
        //-----------------------------
    }
}