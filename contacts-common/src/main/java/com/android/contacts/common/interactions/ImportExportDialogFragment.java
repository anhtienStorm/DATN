...
public class ImportExportDialogFragment extends DialogFragment
    ...
    /*private*/protected static final String ARG_CONTACTS_ARE_AVAILABLE = "CONTACTS_ARE_AVAILABLE";

    /*private*/protected static int mExportMode = EXPORT_MODE_DEFAULT;
    ...
    /*private*/protected SubscriptionManager mSubscriptionManager;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //AnhNDd: custom
        addEntryAdapter(res,contactsAreAvailable,adapter);
        ...
        final DialogInterface.OnClickListener clickListener =
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (resId == R.string.import_from_sim) {
                    ...
                    // Anhdts chi su dung btalk de thuc hien action
                    exportIntent.setPackage(getActivity().getPackageName());
...
//                            + getActivity().getResources().getResourceEntryName(resId));
        ...
        /*return new AlertDialog.Builder(getActivity())
                ...
                .create();*/
        //AnhNDd: custom
        return createDialogFragment(contactsAreAvailable,adapter,clickListener);
    }
    ...
    private class ExportToSimSelectListener implements DialogInterface.OnClickListener {
        public void onClick(DialogInterface dialog, int which) {
            if (which >= 0) {
                ...
                // Anhdts chi su dung btalk de thuc hien action
                pickPhoneIntent.setPackage(mActivity.getPackageName());
    ...
    public class ExportToSimThread extends Thread {
        ...
        // Bkav HuyNQN thuc hien loai bo dau cua tieng viet
        ...
        // Bkav HuyNQN thuc hien cat nameContact cho phu hop de luu tren sim
        private String refreshDisplayName(String name) {
                ...
                if (contactList != null) {
                    ...
                    while (iterator.hasNext() && !canceled && isSimCardLoaded) {
                        ...
                        if (c != null && c.moveToFirst()) {
                            do {
                                ...
                                if (StructuredName.CONTENT_ITEM_TYPE.equals(mimeType)) {
                                    ...
                                    // Bkav HuyNQN thuc hien bo dau va cat chuoi khi chuyen danh ba sang sim
                                    if(name != null) {
                                        name = refreshDisplayName(name);
                                    }
                                }
                        ...
                        if (freeSimCount > 0 && 0 == arrayNumber.size()
                                && 0 == arrayEmail.size()) {
                            // Anhdts bo thong bao gay roi cho nguoi dung
...
//                                    TOAST_EXPORT_NO_PHONE_OR_EMAIL, name));
                        ...
                        for (int i = 0; i < groupCount; i++) {
                            if (freeSimCount > 0) {
                                ...
                                result = insertToCard(mPeople, name, num,
            ...
            public void handleMessage(Message msg) {
                ...
                case TOAST_SIM_CARD_NOT_LOAD_COMPLETE:
                    Toast.makeText(mPeople,
                            R.string.sim_contacts_not_load, Toast.LENGTH_LONG)
                            .show();
                    break;
    ...
    TelephonyManager tm = (TelephonyManager) mActivity.getSystemService(
        ...
        if (id == R.string.import_from_sim_select) {
            listener = new ImportFromSimSelectListener();
            showSimSelectDialog();
        } else if (id == R.string.export_to_sim) {
    ...
    /*private*/protected static class AdapterEntry {
    ...
    //======================BKAV=====================================
    /**
     * AnhNDd: thực hiện việc hiển thị chức năng nhập, xuất như thế nào.
     */
    public void addEntryAdapter(Resources res, boolean contactsAreAvailable, ArrayAdapter<AdapterEntry> adapter){
        final TelephonyManager manager =
                (TelephonyManager) getActivity().getSystemService(Context.TELEPHONY_SERVICE);
        if (res.getBoolean(R.bool.config_allow_import_from_vcf_file)) {
            adapter.add(new AdapterEntry(getString(R.string.import_from_vcf_file),
    ...
    /**
     * AnhNDd: Thực hiện khởi tạo dialog khi đã có dữ liệu.
     */
