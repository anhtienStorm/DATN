...
public class Contact {
    ...
    private final String mCustomRingtoneSms;
    ...
    public Contact(Uri requestedUri, Uri uri, Uri lookupUri, long directoryId, String lookupKey,
            ...
            boolean isUserProfile, String customRingtoneSms) {
        ...
        // Anhdts
        mCustomRingtoneSms = customRingtoneSms;
    }
    ...
    public Contact(Uri requestedUri, Contact from) {
        ...
        // Anhdts
        mCustomRingtoneSms = from.mCustomRingtoneSms;
    }
    ...
    // Anhdts
    public String getCustomRingtoneSms() {
        return mCustomRingtoneSms;
    }
}
