...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    protected boolean mCircularPhotos = true;
    ...
    private void updateIndexer(Cursor cursor) {
        ...
        if (bundle.containsKey(Contacts.EXTRA_ADDRESS_BOOK_INDEX_TITLES) &&
            ...
            if (getExtraStartingSection()) {
                ...
                customSetIndexer(allSections, allCounts);
            } else {
                //setIndexer(new ContactsSectionIndexer(sections, counts));
                //AnhNDd: tach code de custom
                customSetIndexer(sections, counts);
            }
        } else {
            setIndexer(null);
        }
...
//        }
    ...
    protected void bindQuickContact(final ContactListItemView view, int partitionIndex,
        ...
        // Bkav TienNAb: set onclick cho icon contact
        setOnClickPhotoView(quickContact, cursor.getLong(contactIdColumn), cursor.getString(lookUpKeyColumn));
    }
    ...
    /**
     * Bkav QuangNDb them ham get sdt
     */
    public String getPhoneNumber(int position) {
        return "";
    }

    // Bkav QuangNDb them bien so la khi search
    protected String mUnknownPhoneNumber;

    public void setUknowPhoneNumber(String unknownPhoneNumber) {
        this.mUnknownPhoneNumber = unknownPhoneNumber;
    }

    /**
     * Anhdts
     * set ocClick cho icon
     */
    protected void setOnClickPhotoView(QuickContactBadge onClickPhotoView, long idAccount, String string) {
    }
}
