...
public abstract class BaseAccountType extends AccountType {
    ...
    protected DataKind addDataKindDisplayName(Context context) throws DefinitionException {
        ...
        if (!displayOrderPrimary) {
            ...
            // Bkav HienDTk: fix loi: Danh bạ - BOS 8.7 - Lỗi: Mũi tên danh sách mở rộng của trường dữ liệu Tên theo phiên âm không thay đổi chiều sau khi chạm vào => BOS-2589 - Start
           // Tên
            kind.fieldList.add(new EditField(StructuredName.GIVEN_NAME, R.string.name_given,
                    FLAGS_PERSON_NAME).setLongForm(true));
            //Danh xưng
            kind.fieldList.add(new EditField(StructuredName.PREFIX, R.string.name_prefix,
                    FLAGS_PERSON_NAME).setLongForm(true));
            // Bkav HienDTk: fix loi: Danh bạ - BOS 8.7 - Lỗi: Mũi tên danh sách mở rộng của trường dữ liệu Tên theo phiên âm không thay đổi chiều sau khi chạm vào => BOS-2589 - End
