...
public class AboutPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //AnhNDd: custom
        setIntentLicensePreference(licensePreference);

        //Bkav QuangNDb khong can dung policy va term of service nua
...
//        termsOfServicePreference.setOnPreferenceClickListener(listener);
    ...
    /**
     * AnhNDd: Thực hiện việc hiển thị dialog webview hiển thị điều khoản sử dụng.
     */
