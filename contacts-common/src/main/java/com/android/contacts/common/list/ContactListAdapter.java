...
public abstract class ContactListAdapter extends ContactEntryListAdapter {
    ...
    protected static class ContactQuery {
        private static final String[] CONTACT_PROJECTION_PRIMARY = !PermissionsUtil.isAndroidQ() ?
            new String[] {
            Contacts._ID,                           // 0
...
//            RawContacts.ACCOUNT_NAME,               // 10
        ...
        private static final String[] CONTACT_PROJECTION_ALTERNATIVE = !PermissionsUtil.isAndroidQ() ?
            new String[] {
            Contacts._ID,                           // 0
...
//            RawContacts.ACCOUNT_NAME,               // 10
        ...
        private static final String[] FILTER_PROJECTION_PRIMARY = !PermissionsUtil.isAndroidQ() ?
                new String[] {
            Contacts._ID,                           // 0
            Contacts.DISPLAY_NAME_PRIMARY,          // 1
            Contacts.CONTACT_PRESENCE,              // 2
...
//            RawContacts.ACCOUNT_NAME,               // 10
        ...
        private static final String[] FILTER_PROJECTION_ALTERNATIVE = !PermissionsUtil.isAndroidQ() ?
                new String[] {
            Contacts._ID,                           // 0
            Contacts.DISPLAY_NAME_ALTERNATIVE,      // 1
            Contacts.CONTACT_PRESENCE,              // 2
...
//            RawContacts.ACCOUNT_NAME,               // 10
    ...
    protected ContactListItemView newView(
        ...
        //AnhNDd: tach source de custom
        ContactListItemView view = createNewView(context, partition, cursor, position, parent);
    ...
    /**
     * AnhNDd: tạo mới itemview contacts
     * @param context
     * @param partition
     * @param cursor
     * @param position
    ...
    /**
     * AnhNDd: Thực hiện kiểm tra xem có my profile hay không.
     * @param cursor
     */
    ...
    /**
     * AnhNDd: Set header neu có số điện thoại yêu thích
     * @param cursor
     */
    ...
    /**
     * AnhNDd: set header nếu có số điện thoại thường xuyên liên hệ.
     * @param cursor
     */
    ...
    /**
     * AnhNDd: Hiển thị đường gạch ngang nếu có header.
     */
