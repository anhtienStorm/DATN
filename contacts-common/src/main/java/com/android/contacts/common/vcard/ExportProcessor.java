...
public class ExportProcessor extends ProcessorBase {
    ...
    /*private*/protected final VCardService mService;
    private final ContentResolver mResolver;
    private final NotificationManager mNotificationManager;
    /*private*/protected final ExportRequest mExportRequest;
    ...
    private void runInternal() {
        ...
        try {
            ...
            //AnhNDd: custom
            composer = createComposerVCard(vcardType);
    ...
    public VCardComposer createComposerVCard(int vcardType){
        return new VCardComposer(mService, vcardType, true);
    }
}
