...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    /*private*/protected int mVerticalScrollbarPosition = getDefaultVerticalScrollbarPosition();
    ...
    /*private*/protected T mAdapter;
    protected View mView;
    /*private*/protected ListView mListView;
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == DIRECTORY_LOADER_ID) {
            ...
            if (mIsConvertPhone) {
                ...
                String newSelection = prevSelection + " AND " + SELECTION_CONVERT_PHONE + PHONE_0162 + PHONE_0163
                        + PHONE_0164 + PHONE_0165 + PHONE_0166 + PHONE_0167 + PHONE_0168 + PHONE_0169
                        + PHONE_0123 + PHONE_0124 + PHONE_0125 + PHONE_0127 + PHONE_0129
                        + PHONE_0120 + PHONE_0121 + PHONE_0122 + PHONE_0126 + PHONE_0128
                        + PHONE_0186 + PHONE_0188
                        + PHONE_0199;
    ...
    /*private*/protected void configureVerticalScrollbar() {
        ...
        if (mListView != null) {
            ...
            mListView.setScrollBarStyle(getScrollBarStyle());
        }
    }
    ...
    protected void setSearchMode(boolean flag) {
        if (mSearchMode != flag) {
            ...
            //AnhNDd: custom
            setSectionHeaderDisplayEnabledInSearchMode(!mSearchMode);
            ...
            if (mAdapter != null) {
                ...
                // TODO: Anhdts fix loi giat khi search - can theo doi them
                // mAdapter.clearPartitions();
                if (!flag) {
                ...
                //AnhNDd: custom
                setConfigureDefaultPartitionInSearchMode(false,flag);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (adjPosition >= 0) {
            ...
            onItemClick(view, adjPosition, id);
        }
    }
     ...
     * Anhdts them vao
     */
    protected void onItemClick(View view, int adjPosition, long id) {
    }
    ...
    /**
     * AnhNDd: Thực hiện việc có hiển thị headertext khi đang tìm kiếm hay không.
     */
    public void setSectionHeaderDisplayEnabledInSearchMode(boolean bool){
        setSectionHeaderDisplayEnabled(bool);
    }

    /**
     * AnhNDd: Thực hiện việc không hiển thị header của partition tron quá trình search.
     * @param showIfEmty
     * @param hasHeader
     */
    public void setConfigureDefaultPartitionInSearchMode(boolean showIfEmty, boolean hasHeader){
        mAdapter.configureDefaultPartition(showIfEmty, hasHeader);
    }

    /**
     * Bkav QuangNDb custom scrollbar style cua scroll view
     */
    protected int getScrollBarStyle() {
        return ListView.SCROLLBARS_OUTSIDE_OVERLAY;
    }

    // Anhdts
    protected boolean mIsConvertPhone = false;

    public void setModeConvertPhone() {
            mIsConvertPhone = true;
    }

    // Bkav HuyNQN khong query theo kieu lay ra toan bo dau so 01% nay nua
    /*private static final String SELECTION_CONVERT_PHONE = "length(" + ContactsContract.CommonDataKinds.Phone.NUMBER +") > 10 and ("
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '01%' or " + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '841%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+841%')";*/

    // Bkav HuyNQN Thuc hien query theo cac dau so co dinh
    private static final String SELECTION_CONVERT_PHONE = "length(" + ContactsContract.CommonDataKinds.Phone.NUMBER +") > 10 and (";

    private static final String PHONE_0162 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0162%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84162%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84162%' or ";

    private static final String PHONE_0163 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0163%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84163%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84163%' or ";

    private static final String PHONE_0164 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0164%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84164%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84164%' or ";

    private static final String PHONE_0165 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0165%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84165%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84165%' or ";

    private static final String PHONE_0166 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0166%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84166%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84166%' or ";

    private static final String PHONE_0167 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0167%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84167%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84167%' or ";

    private static final String PHONE_0168 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0168%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84168%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84168%' or ";

    private static final String PHONE_0169 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0169%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84169%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84169%' or ";
    private static final String PHONE_0123 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0123%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84123%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84123%' or ";

    private static final String PHONE_0124 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0124%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84124%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84124%' or ";

    private static final String PHONE_0125 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0125%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84125%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84125%' or ";

    private static final String PHONE_0127 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0127%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84127%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84127%' or ";

    private static final String PHONE_0129 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0129%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84129%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84129%' or ";

    private static final String PHONE_0120 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0120%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84120%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84120%' or ";

    private static final String PHONE_0121 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0121%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84121%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84121%' or ";

    private static final String PHONE_0122 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0122%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84122%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84122%' or ";

    private static final String PHONE_0126 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0126%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84126%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84126%' or ";

    private static final String PHONE_0128 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0128%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84128%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84128%' or ";

    private static final String PHONE_0186 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0186%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84186%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84186%' or ";

    private static final String PHONE_0188 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0188%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84188%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84188%' or ";

    private static final String PHONE_0199 = ContactsContract.CommonDataKinds.Phone.NUMBER + " like '0199%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '84199%' or "
            + ContactsContract.CommonDataKinds.Phone.NUMBER + " like '+84199%')";
}
