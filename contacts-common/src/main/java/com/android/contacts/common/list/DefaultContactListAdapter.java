...
public class DefaultContactListAdapter extends ContactListAdapter {
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        if (isSearchMode()) {
            ...
            //AnhNDd: custom.
            setUpToQuerySTREQUENT(loader,query,directoryId);
            ...
            if (TextUtils.isEmpty(query)) {
                ...
                //AnhNDd: custom
                loader.setUri(appendUriBuildSectionIndexer(Contacts.CONTENT_URI));

                loader.setProjection(getProjection(false));
                loader.setSelection("0");
            } else {
                //Bkav QuangNDb custom de co the search duoc theo tung account
                ...
                if (mFilter != null
                    ...
                    if (mFilter.filterType == ContactListFilter.FILTER_TYPE_ACCOUNT) {
                        mFilter.addAccountQueryParameterToUrl(builder);
                    }
                }
                final Uri uri = builder.build();
                //AnhNDd: custom
                loader.setUri(appendUriBuildSectionIndexer(uri));
    ...
    private void configureSelection(
        ...
        switch (filter.filterType) {
            case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS: {
                ...
                if (!PermissionsUtil.isAndroidQ()){
                    selection.append(RawContacts.ACCOUNT_TYPE + " != 'com.skype.raider' or " + RawContacts.ACCOUNT_TYPE +" is null ");
                }
                break;
            }
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        // Bkav HuyNQN fix loi khong the click vao item
        ...
        //AnhNDd: custom
        hookToSetOnClickPhotoView(itemView, position);

        // Bkav HuyNQN su ly click voi truong hop co nhieu so dien thoai voi nut sms va call
        buttonClickWithMultiNumber(itemView);
    }
    ...
    /**
     * AnhNDd: Thực hiện việc thêm yêu cầu đếm số contact có cùng chữ cái.
     * @param uri
     * @return
     */
    ...
    /**
     * AnhNDd: Thiết lập cho việc tìm kiếm số điện thoại yêu thích và thường xuyên liên hệ
     * @param loader
     * @param query
     * @param directoryId
     */
    ...
    /**
     * AnhNDd: set sự kiện onclick cho photoview.
     */
