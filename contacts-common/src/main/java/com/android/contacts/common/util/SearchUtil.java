...
//        }
        ...
        // Bkav HaiKH - Fix bug BOS-2925- Start
        // Check kí tự đầu tiên của chuỗi tìm kiếm
        if (Character.isLetterOrDigit(query.codePointAt(start)) || end != start) {
        ...
        // Bkav HaiKH - Fix bug BOS-2925- End
