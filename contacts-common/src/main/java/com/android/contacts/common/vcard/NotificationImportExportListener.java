...
public class NotificationImportExportListener implements VCardImportExportListener,
     ...
     */
    /* package */ @RequiresApi(api = Build.VERSION_CODES.O)
    static Notification constructProgressNotification(
        ...
        // Bkav HuyNQN fix loi khong hien notification khi nhap/xuat danh ba khi nâng sdk version lên 28
    ...
    /* package */ static Notification constructCancelNotification(
        ...
        // Bkav TienNAb: fix loi thong bao khi nang target version len 28
        String channelId = context.getString(R.string.app_name);
