...
public class ContactTileAdapter extends BaseAdapter {
    ...
    /*private*/protected /*final*/ int mWhitespaceStartEnd;
...
//            mAccountNameIndex = ContactTileLoaderFactory.ACCOUNT_NAME;
     ...
     */
    /*private*/protected TextView getDivider() {
    ...
    private int getLayoutResourceId(int viewType) {
        switch (viewType) {
            ...
            case ViewTypes.FREQUENT:
                ...
                //AnhNDd: custom
                return getLayoutViewTypesFREQUENT();
            default:
    ...
    private class ContactTileRow extends FrameLayout {
        ...
        private void addTileFromEntry(ContactEntry entry, int childIndex, boolean isLastRow) {
            ...
            if (getChildCount() <= childIndex) {
                ...
                // Anhdts xu ly view hien danh ba chi tiet
                setActionShowDetail(contactTile);
                addView(contactTile);
            } else {
    ...
    /**
     * AnhNDd: trả về view của item trong tab thường xuyên liên hệ
     */
     ...
     */
    protected void setActionShowDetail(ContactTileView contactTile) {
