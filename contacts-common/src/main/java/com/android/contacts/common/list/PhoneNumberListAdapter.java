...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    public static class PhoneQuery {
        ...
        public static final String[] PROJECTION_PRIMARY_INTERNAL = !PermissionsUtil.isAndroidQ() ?
            new String[] {
            Phone._ID,                          // 0
            Phone.TYPE,                         // 1
            Phone.LABEL,                        // 2
...
//            RawContacts.ACCOUNT_NAME,           // 10
        ...
        public static final int CARRIER_PRESENCE        = !PermissionsUtil.isAndroidQ() ? 11 : 9;
    }
    ...
    protected final String mCountryIso;
    ...
    public void configureLoader(CursorLoader loader, long directoryId) {
        ...
        if (isExtendedDirectory(directoryId)) {
            ...
            if (isSearchMode()) {
                // Bkav QuangNDb them ham nay vao de search khong bi loi doan yeu thich va frequently
                invalidFrequentAndFavorite(loader,query, directoryId);
                final Uri baseUri;
                if (isRemoteDirectoryQuery) {
                    baseUri = getBaseSearchUri();
                ...
                setUpSearchBuilder(builder, query, directoryId, isRemoteDirectoryQuery);
            } else {
...
//            if (isSearchMode()) {
//                newSelection += getSelectionIfSearchMode(query);
//            }
    ...
    protected ContactListItemView newView(
        ...
        // BKav QuangNDb tach code doan nay de sua o lop con
        ContactListItemView view = getContactListItemView(context, partition, cursor, position, parent);
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
        ...
        // Bkav QuangNDb tach code doan concat ContactListItemView de override lai o class con
        ContactListItemView view = getContactListItemView(itemView);
        // Bkav QuangNDb them ham add view gach ngang giua moi contact
        addDividerSection(view);
        bindColorText(view); // TrungTH them ham bind color text
        ...
        if (cursor.moveToPrevious() && !cursor.isBeforeFirst()) {
            ...
            if (currentContactId == previousContactId && !getCheckFirstEntry(position)) {
                isFirstEntry = false;
                view.setFirstEntry(false);
            }else {
                view.setFirstEntry(true);
            }
        }else {//Bkav QuangNDb sua loi bi bop lien he dau tien do bi nham voi lien he co n so dien thoai
            view.setFirstEntry(true);
        }
        cursor.moveToPosition(position);
        ...
        if (isFirstEntry || isConfigNotRemoveView()) {
            ...
            //Bkav QuangNDb Build so dien thoai phu TH danh ba co nhieu so dien thoai
            unbindName(view);
        ...
        // Bkav QuangNDb them TH xu ly so la
//        if (cursor.getCount() == 0) {
//            Toast.makeText(getContext(), "Test", Toast.LENGTH_SHORT).show();
//            setNotFoundSearchResult(view);
//        }
    }
    ...
    protected void bindPhoneNumber(ContactListItemView view, Cursor cursor, boolean displayNumber,
        ...
        // Anhdts
        setPhoneNumber(view, text, cursor.getLong(PhoneQuery.PHONE_ID), getUpperCaseQueryString());
    ...
    protected void bindSectionHeaderAndDivider(final ContactListItemView view, int position) {
        if (isSectionHeaderDisplayEnabled()) {
            ...
            //AnhNDd: custom
            bindDividerSection(view,position);
        } else {
    ...
    /**
     * ------------------------------------------------------------BKAV---------------------------------------------------
     * Bkav QuangNDb: tach code doan get contact list item view override lai o class con
     */
    ...
    /**
     * Bkav QuangNDb add divider giua moi contact
     */
    ...
    /**
     * Bkav TrungTH bindColorText
     */
    public void bindColorText(ContactListItemView view) {
    }

    /**
     *Bkav QuangNDb tach code doan set builder search
     */
    protected void setUpSearchBuilder(Builder builder, String query, long directoryId, boolean isRemoteDirectoryQuery) {
    ...
    /**
     * Bkav QuangNDb get builder search
     */
    protected Uri getBaseSearchUri() {
        return PhoneCompat.getContentFilterUri();
    }

    /**
     * Bkav QuangNDb them ham lay selection khi seach
     */
    ...
    /**
     * Bkav QuangNDb them ham check xem co phai phan tu dau tien hay khong
     */
    ...
    /**
     * BKav QuangNDb them ham xu ly TH so la tai day
     */
    protected void setNotFoundSearchResult(ContactListItemView view) {
        // Bkav QuangNDb them TH xu ly so la tai day
    }
