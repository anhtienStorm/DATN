...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    public static final String CUSTOM_RINGTONE_SMS = "custom_ringtone_sms";
    ...
    private static class ContactQuery {
        ...
        static {
            ...
            if (CompatUtils.isOCompatible()) {
                projectionList.add("custom_ringtone_sms");
            }
        ...
        public static final int CUSTOM_RINGTONE_SMS = 65;
    }
    ...
    private Contact loadContactHeaderData(final Cursor cursor, Uri contactUri) {
        ...
        // Anhdts
        final String customRingtoneSms;
        if (CompatUtils.isOCompatible()) {
            customRingtoneSms = cursor.getString(ContactQuery.CUSTOM_RINGTONE_SMS);
        } else {
            customRingtoneSms = null;
        }
        ...
        return new Contact(mRequestedUri, contactUri, lookupUri, directoryId, lookupKey,
                ...
                customRingtone, isUserProfile, customRingtoneSms);
    }
    ...
    protected void onStartLoading() {
        // Anhdts them doan check neu khong trung lookupUri thi bo qua
        if (mContact != null && mContact.getLookupUri() != null && mContact.getLookupUri().equals(mLookupUri)) {
