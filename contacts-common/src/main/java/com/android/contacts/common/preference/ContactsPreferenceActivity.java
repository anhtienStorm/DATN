...
public /*final*/ class ContactsPreferenceActivity extends PreferenceActivity {
    ...
    /*private*/protected static final String TAG_ABOUT_CONTACTS = "about_contacts";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            /*getFragmentManager().beginTransaction()
                    ...
                    .commit();*/
            //AnhNDd: thay doi code de custom
            createDisplayOptionsPreferenceFragment();
    ...
    //=====================Bkav=====================
    //AnhNDd: Thực hiện khởi tạo fragment options
    ...
    //AnhNDd: Thực hiện việc khởi tạo Fragment cho phần giới thiệu ve danh bạ.
