...
public class NameConverter {
    ...
    public static Map<String, String> displayNameToStructuredName(Context context,
        ...
        // Anhdts tam thoi khong tu phan tach ten, vi tieng anh va tieng viet
        // vi tri ten chinh dat nguoc nhau. Muon doi thi mo rong va xu ly
        for (String STRUCTURED_NAME_FIELD : STRUCTURED_NAME_FIELDS) {
            structuredName.put(STRUCTURED_NAME_FIELD,
                    STRUCTURED_NAME_FIELD.equals(StructuredName.GIVEN_NAME) ? displayName : null);
        }
