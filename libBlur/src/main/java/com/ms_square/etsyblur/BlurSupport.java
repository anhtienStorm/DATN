...
public class BlurSupport {
    ...
    public static void addTo(@NonNull final DrawerLayout drawerLayout, View background, int colorId) {
        ...
        ((BlurringView) blurringView).blurredView(viewToBlur, colorId);
        ((BlurringView) blurringView).startBlur(true); // Bkav TrungTh them vao de thong bao co thuc hien blur view
