...
class ContentLayout : RelativeLayout, JellyWidget {
    ...
    @DrawableRes var iconRes: Int? = null
        set(value) {
            value?.let {
                search_icon.setImageResource(it)
                field = value
            }
        }
    @DrawableRes var cancelIconRes: Int? = null
        set(value) {
            value?.let {
                cancel_search_icon.setImageResource(it)
                field = value
            }
        }
    ...
    internal var onIconClickListener: OnClickListener? = null
        set(value) {
            search_icon.setOnClickListener(value)
            field = value
        }
    internal var onCancelIconClickListener: OnClickListener? = null
        set(value) {
            cancel_search_icon.setOnClickListener(value)
            field = value
        }
    ...
    override fun collapse() {
        ValueAnimator.ofFloat(endPosition, startPosition).apply {
            ...
            addUpdateListener {
                ...
                search_icon.alpha = 0.5f + 0.5f * animatedFraction

                with(cancel_search_icon) {
    ...
    override fun expand() {
        ValueAnimator.ofFloat(startPosition, endPosition).apply {
            ...
            addUpdateListener {
                translationX = animatedValue as Float
                search_icon.alpha = 1f - 0.5f * animatedFraction
            }
        }.start()
    }
