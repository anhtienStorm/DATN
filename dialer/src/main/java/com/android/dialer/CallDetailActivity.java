...
public class CallDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mCallButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                makeCallNumber();  // Bkav HuyNQN tach ham xu ly lai o lop con
            }
        });
        ...
        //TODO TrungTH them co de status icon den, ham nay dung nhieu, cach can tao 1 lop utils bkav o duoi cung, de cac lop khac dung
        ...
        if (item.getItemId() == R.id.call_detail_delete_menu_item) {
            if (hasVoicemail()) {
                ...
                CallLogAsyncTaskUtil.deleteCalls(
                        this, callIds.toString(), mCallLogAsyncTaskListener, getCallLogEntryUris().length);
            }
        }
        return true;
    }
    ...
    public void onClick(View view) {
        ...
        if (resId == R.id.call_detail_action_block) {
            // Bkav HuyNQN xu dung chan so cua BMS
            showDiaLogCallsBlocksWithBMS();
    ...
    protected Drawable getDrawable() {
        return ContextCompat.getDrawable(this, R.drawable.ic_delete_24dp);
    }

    /**
     * Anhdts su dung ham chinh sua so truoc khi goi cu
     */
    protected boolean useDefaultMethod(String number) {
        return true;
    }

    // Bkav HuyNQN tach ham thuc hien goi dien de su ly lai logic o lop con
    ...
    // Bkav HuyNQN check xem so nay co dang bi chan hay khong
    ...
    protected void updateUnblocksTitle(){
        mBlockNumberActionItem.setText(R.string.action_unblock_number);
        mBlockNumberActionItem.setCompoundDrawablesRelativeWithIntrinsicBounds(
                R.drawable.ic_call_detail_unblock, 0, 0, 0);
    ...
    protected void updateBlocksTitle(){
        mBlockNumberActionItem.setText(R.string.action_block_number);
        mBlockNumberActionItem.setCompoundDrawablesRelativeWithIntrinsicBounds(
                R.drawable.ic_call_detail_block, 0, 0, 0);
    }
