...
public class SoundSettingsFragment extends PreferenceFragment
    ...
    protected static final int MSG_UPDATE_RINGTONE_SUMMARY = 1;

    protected Preference mRingtonePreference;
    ...
    protected final Handler mRingtoneLookupComplete = new Handler() {
        @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Anhdts find 2 view custom ring tone sim 1 va 2
        findPref();
