...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    protected String mFormattedQueryString;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (shortcutType >= 0) {
            if (convertView != null) {
                ...
                final ContactListItemView v = newContactListItemView(getContext(),
    ...
    public int getShortcutTypeFromPosition(int position) {
        ...
        if (shortcutCount >= 0) {
            ...
            throw new IllegalArgumentException("Invalid position - greater than cursor count "
                    + " but not a shortcut." +shortcutCount);
        }
    ...
    protected void assignShortcutToView(ContactListItemView v, int shortcutType) {
