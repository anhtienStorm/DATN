...
public class PhoneFavoriteSquareTileView extends PhoneFavoriteTileView {
    ...
    private void launchQuickContact() {
        if (CompatUtils.hasPrioritizedMimeType()) {
            //HienDTk: start activity o trong app de luc back lai khong bi back ve laucher
            final Intent intentGo = ImplicitIntentsUtil.composeQuickContactIntent(
                    getLookupUri(), ContactsContract.QuickContact.MODE_LARGE);
            ImplicitIntentsUtil.startActivityInApp(getContext(), intentGo);
