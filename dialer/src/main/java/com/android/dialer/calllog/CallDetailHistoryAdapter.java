...
public class CallDetailHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Bkav HuyNQN tach ham de xu ly them customview de play recorder
        setRecorderAudioCustomView(details,result);
    ...
    // Bkav HuyNQN ham nay xu ly o lop con
