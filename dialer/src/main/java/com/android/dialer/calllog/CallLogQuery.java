...
public final class CallLogQuery {
    ...
    private static final String[] _PROJECTION_INTERNAL = new String[] {
            ...
            CallLogQueryHandler.RECORD_CALL_DATA, //23 HuyNQn them cot record_call_data.
            CallLogQueryHandler.LABEL_BMS_SPAM_VN, //24 QuangNDb them cot spam vn
            CallLogQueryHandler.LABEL_BMS_SPAM_ENG, //25 QuangNDb them cot spam eng
    };
    ...
    //Bkav QuangNDb them index query de lay
    public static final int RECORD_CALL_DATA_INDEX = 23;
    public static final int LABEL_BMS_SPAM_VN_INDEX = 24;
    public static final int LABEL_BMS_SPAM_ENG_INDEX = 25;
