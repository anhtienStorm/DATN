 ...
 */
public class PhoneCallDetailsViews {
    ...
    protected PhoneCallDetailsViews(TextView nameView, View callTypeView,
    ...
    // Anhdts view hien thi so dien thoai
    public TextView numberView; // Bkav TrungTH tam sua thanh giong tren
    public FrameLayout customRecorder; // Bkav HuyNQN them customview de su dung o PhoneCallDetailsView
    public TextView dateIfSpamExist; //Bkav QuangNDb view date khi co noi dung spam
    public TextView numberDateSpace; //Bkav QuangNDb view " - "
}
