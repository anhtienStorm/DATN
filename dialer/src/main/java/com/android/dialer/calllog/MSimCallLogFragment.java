...
public class MSimCallLogFragment extends Fragment implements CallLogQueryHandler.Listener,
    ...
    public void fetchCalls() {
        if (false/*mFilterSubSpinnerView.isEnabled()*/) {
            //TODO Bkav TrungTH dong lai do khong co ham getSubID
...
//            }
    ...
    private void updateFilterSpinnerViews() {
        ...
        final SubscriptionManager subscriptionManager = (SubscriptionManager) getContext().getSystemService(Context.TELEPHONY_SUBSCRIPTION_SERVICE);
