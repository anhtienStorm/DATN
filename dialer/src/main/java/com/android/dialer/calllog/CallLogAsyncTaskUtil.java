    ...
    public static void deleteCalls(
        ...
        sAsyncTaskExecutor.submit(Tasks.DELETE_CALL, new AsyncTask<Void, Void, Void>() {
            ...
            public void onPostExecute(Void result) {
                ...
                // Bkav HienDTk: them thong bao khi xoa lien he trong callog
                Toast.makeText(context,  context.getString(R.string.delete_contact_callog, countFileSelect), Toast.LENGTH_LONG).show();
            }
        });
    }
