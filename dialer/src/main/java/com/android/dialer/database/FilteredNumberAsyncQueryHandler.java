...
public class FilteredNumberAsyncQueryHandler extends AsyncQueryHandler {
    ...
    public boolean isBlockedNumber(
        ...
        // Anhdts khong dung libphone mac dinh cua sdk vi no khong duoc update thuong xuyen
//        final String e164Number = PhoneNumberUtils.formatNumberToE164(number, countryIso);
        String e164Number = DialerCompatUtils.formatNumberE164(number, countryIso);
        ...
        startQuery(NO_TOKEN,
                ...
                FilteredNumberCompat.getOriginalNumberColumnName() + " = ? or " +
                        FilteredNumberCompat.getE164NumberColumnName() + " = ?",
                new String[]{number, e164Number},
                null);
    ...
    public void blockNumber(
        ...
        // Anhdts
        String numberFormat = DialerCompatUtils.formatNumberE164(number, countryIso);
        blockNumber(listener, numberFormat, number, countryIso);
    }
