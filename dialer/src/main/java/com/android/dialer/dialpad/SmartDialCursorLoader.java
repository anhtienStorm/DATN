...
public class SmartDialCursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        ...
        for (ContactNumber contact : allMatches) {
            ...
            bindCarrierPreSence(row, contact); // Bkav TrungTH  Thay bang ham cua minh re nhanh M moi them
    ...
    private void bindCarrierPreSence(Object[] row, ContactNumber contact) {
