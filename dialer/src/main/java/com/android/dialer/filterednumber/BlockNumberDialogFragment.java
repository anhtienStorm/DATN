...
public class BlockNumberDialogFragment extends DialogFragment {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (isBlocked) {
                            if (isDefaultSmsApp()){
                                ...
                                Toast.makeText(getContext(), R.string.toast_block_number_without_permission,Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            if (isDefaultSmsApp()){

                                //Todo HuyNQn: chan so o day
                                blockNumber();
                            } else {
                                Toast.makeText(getContext(), R.string.toast_block_number_without_permission,Toast.LENGTH_SHORT).show();
                            }
    ...
    // Bkav TienNAb: ham check xem co phai app sms mac dinh khong
    public boolean isDefaultSmsApp() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            final String configuredApplication = Telephony.Sms.getDefaultSmsPackage(getContext());
            return  getContext().getPackageName().equals(configuredApplication);
        }
        return true;
    }
