...
public class SpecialCharSequenceMgr {
    ...
    static boolean handleSecretCode(Context context, String input) {
        ...
        if (len > 8 && input.startsWith("*#*#") && input.endsWith("#*#*")) {
            //Bkav QuangNDb ban cho ben DucLQ xu ly, loi crash scret code
            Intent intent = new Intent("bkav.provider.Telephony.SECRET_CODE");
            intent.putExtra("secret_code", input.substring(4, len - 4));
    ...
    static boolean handleDeviceIdDisplay(Context context, String input) {
        ...
        //Bkav QuangNDb sua lai logic get imei moi thay the cho cach cu
