...
public class ObjectFactory {
    ...
    // Bkav HuyNQN them authority de lay du lieu tu bang smartdialer
    public static String getTableSmartDialerProviderAuthority() {
        return "bkav.android.dialer.database.smartdialerprovider";
    }
    ...
    public static String getFilteredNumberProviderAuthority() {
        return "bkav.android.dialer.database.filterednumberprovider";
    }
    // Bkav Trungth: sua tam com sang android de build duoc ko phai go app dialer ra
    public static String getVoicemailArchiveProviderAuthority() {
        return "bkav.android.dialer.database.voicemailarchiveprovider";
    }
