 ...
 */
public class BugleApplication implements UncaughtExceptionHandler {
    ...
    public void onCreate() {
        ...
        // Bkav Trungth: bo super va thay Application vao vi ko extends Application nua
    ...
    public void uncaughtException(final Thread thread, final Throwable ex) {
        // Bkav Trungth: thay Application vao vi ko extends Application nua
        final boolean background = mApplication.getMainLooper().getThread() != thread;
        if (background) {
            LogUtil.e(TAG, "Uncaught exception in background thread " + thread, ex);

            final Handler handler = new Handler(mApplication.getMainLooper());
    ...
    private void maybeHandleSharedPrefsUpgrade(final Factory factory) {
        ...
        // Bkav Trungth: thay Application vao vi ko extends Application nua
        final int targetVersion = Integer.parseInt(mApplication.getString(R.string.pref_version));
    ...
    // Bkav Trungth: bo xung ham khoi tao vi bo extends tu application di, do phai gop 3 lop application vao lam 1
    protected Application mApplication;

    public BugleApplication(Application application) {
        mApplication = application;
    }

    /**
     * Bkav QuangNdb tach ham ra de lop con co the override duoc
     */
    protected void createFactory(){
        FactoryImpl.register(mApplication.getApplicationContext(), this);
    }
}
