...
public class BugleWidgetProvider extends BaseWidgetProvider {
    ...
    public static void notifyConversationListChanged(final Context context) {
        ...
        // QuangNDb comment lai de khong bi log crash sending non-protected broadcast from system, comment lai cung khong anh huong vi toan bo widget phan message da bi bo di
