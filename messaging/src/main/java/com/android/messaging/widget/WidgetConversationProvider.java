...
public class WidgetConversationProvider extends BaseWidgetProvider {
    ...
    public static void notifyMessagesChanged(final Context context, final String conversationId) {
        ...
        // TODO: 17/08/2017 QuangNDb comment doan nay lai vi no gay ra log canh bao non protected tren android 7.1.2
        // , cung khong can dung nua vi da bo phan widget trong tin nhan di r
