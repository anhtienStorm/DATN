...
public class MessageData implements Parcelable {
    private static final String[] sProjection = {
        ...
        MessageColumns.INCOMING_SLOT_ID,
        MessageColumns.ICCID,
    };
    ...
    private static final int INDEX_INCOMING_SLOT_ID = 19;
    private static final int INDEX_ICCID = 20;

    // SQL statement to insert a "complete" message row (columns based on the projection above).
    // QuangNDb them ham insert co ca slot id
    ...
    // QuangNDb them cot incomingslotid de nhan ra tin nhan dc gui den sim 1 hay la sim 2
    ...
    public static MessageData createReceivedSmsMessage(final Uri uri, final String conversationId,
            ...
            final boolean seen, final boolean read, final int incomingSlotId, final String iccid) {
        final MessageData message = new MessageData();
        ...
        message.mRead = read;
        // QuangNDb them
        message.mIncomingSlotId = incomingSlotId;
        message.mIccid = iccid;
        return message;
    }
    ...
    public static MessageData createSmsMessage(final String messageUri, final String participantId,
            ...
            final long recieved, final String messageText, String iccid) {
        final MessageData message = new MessageData();
        message.mParticipantId = participantId;
        message.mSelfId = selfId;
        message.mConversationId = conversationId;
    ...
    public static MessageData createMmsMessage(final String messageUri, final String participantId,
            ...
            final long received, final String iccid) {
        final MessageData message = new MessageData();
        message.mParticipantId = participantId;
        message.mSelfId = selfId;
        message.mConversationId = conversationId;
    ...
    public void populate(final ContentValues values) {
        ...
        values.put(MessageColumns.ICCID, mIccid);
    }
    ...
    public SQLiteStatement getInsertStatement(final DatabaseWrapper db) {
        ...
        // QuangNDb them insert incoming slot id
        insert.bindLong(INDEX_INCOMING_SLOT_ID, mIncomingSlotId);
        if (mIccid != null) {
            insert.bindString(INDEX_ICCID, mIccid);
        }
        return insert;
    }
