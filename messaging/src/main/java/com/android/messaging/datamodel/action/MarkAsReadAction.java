...
public class MarkAsReadAction extends Action implements Parcelable {
    ...
    public static void markAsRead(final String conversationId) {
        ...
        // Bkav TienNAb: huy lap lich sau 30s hien thi thong bao an tin nhan
        Intent intent = new Intent(Factory.get().getApplicationContext(), DeleteNotificationReceiver.class);
    ...
    protected Object executeAction() {
        ...
        Log.d(TAG, "executeAction: as read and update notify");
