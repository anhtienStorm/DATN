...
public class UpdateConversationArchiveStatusAction extends Action {
    ...
    protected Object executeAction() {
        ...
        try {
            ...
            //Bkav QuangNDb neu unarchive thi bo blocked lien he da block
            if (!isArchived) {
                String destination = BugleDatabaseOperations.getOtherParticipantDestinationFromConversation(db,conversationId);
                BugleDatabaseOperations.updateDestination(db, destination, false);
            }
