...
public class ConversationListItemData {
    ...
    //Bkav QuangNDb them last message iccid
    public String getLastMessageIccid() {
        return mLastMessageIccid;
    }

    private String mLastMessageIccid;//Bkav QuangNDb
    ...
    public void bind(final Cursor cursor, final boolean ignoreDraft) {
        ...
        mLastMessageIccid = cursor.getString(INDEX_LAST_MESSAGE_ICCID);
    }
    ...
    private static final String CONVERSATION_LIST_VIEW_PROJECTION =
            ...
            + " as " + ConversationListViewColumns.IS_ENTERPRISE+ ", "
                    ...
                    + " as " + ConversationListViewColumns.LAST_MESSAGE_ICCID;
    ...
    public static class ConversationListViewColumns implements BaseColumns {
        ...
        public static final String SORT_TIMESTAMP = ConversationColumns.SORT_TIMESTAMP;
        ...
        //Bkav QuangNDb them cot iccid cua tin  nhan cuoi cung
        static final String LAST_MESSAGE_ICCID = MessageColumns.ICCID;
    }
    ...
    public static final String[] PROJECTION = {
        ...
        ConversationListViewColumns.LAST_MESSAGE_ICCID,//Bkav QuangNDb
    };
    ...
    private static final int INDEX_LAST_MESSAGE_ICCID = 30;//Bkav QuangNDb
    ...
    public static String generateConversationName(final List<ParticipantData>
        ...
        for (final ParticipantData participant : participants) {
            ...
            //Bkav QuangNDb Do ham static khong sua duoc nen sua truc tiep thanh hien thi full name khi tao tin nhan group
            participantNames.add(participant.getDisplayName(true));
        }
