...
public class PeopleOptionsItemData {
    ...
    public static final int SETTING_BLOCKED = /*3*/ 2;
    public static final int SETTINGS_COUNT = /*4*/ 3;
    ...
    public void bind(
        ...
        switch (settingType) {
            ...
            case SETTING_NOTIFICATION_SOUND_URI:
                ...
                Uri ringtoneUri ;
                // Bkav HienDTk: neu khong cai dat am thanh trong conversation thi uu tien lay am thanh trong am bao => BOS-2873 - Start
                if(TextUtils.isEmpty(ringtoneString)){
                    ringtoneUri = getUriRingtone();
                    // Bkav HienDTk: neu khong lay duoc uri tu am bao thi lay tu conversation
                    if(ringtoneUri == null){
                        ringtoneUri = RingtoneUtil.getNotificationRingtoneUri(ringtoneString);
                    }
                }else {
                    ringtoneUri = RingtoneUtil.getNotificationRingtoneUri(ringtoneString);
                }
                // Bkav HienDTk: neu khong cai dat am thanh trong conversation thi uu tien lay am thanh trong am bao => BOS-2873 - End
                ...
                break;
            // Bkav TienNAb: tam thoi bo tinh nang bat/tat rung thong bao tin nhan
...
//                break;
    ...
    /**
     * HienDTk: lay uri trong am bao (lay thong qua NotificationChannel) => BOS-2873
     */
    private Uri getUriRingtone(){
        Uri ringtoneUri = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager notificationManager = (NotificationManager) mContext.getSystemService(Context.NOTIFICATION_SERVICE);
            NotificationChannel mChannel = notificationManager.getNotificationChannel(mContext.getString(R.string.message_notification_chanel_id));

            if (mChannel!=null) {
                ringtoneUri = mChannel.getSound();
            }
        }
        return ringtoneUri;
    }
