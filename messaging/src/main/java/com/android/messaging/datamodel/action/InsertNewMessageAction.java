...
public class InsertNewMessageAction extends Action implements Parcelable {
    ...
    /**
     * Insert message (no listener) with a given non-default mSlotId.
     */
    ...
    protected Object executeAction() {
        ...
        if (isSms) {
            ...
            final String iccid = PhoneUtils.getDefault().getDefaultSmsIccid(subId);
            messageToSend.setIccid(iccid);
    ...
    private ParticipantData getSelf(
        ...
        // Check if we are asked to bind to a non-default mSlotId. This is directly passed in from
        ...
        //Bkav QuangNDb them logic iccid
        String iccid = PhoneUtils.getDefault().getDefaultSmsIccid(requestedSubId);
    ...
    private void insertBroadcastSmsMessage(final String conversationId,
        ...
        if (iccid != null) {
            ...
            messageUri = MmsUtils.insertSmsMessage(context,
                    ...
                    Telephony.Sms.MESSAGE_TYPE_SENT, threadId, iccid);
        }else {
            // Insert message into telephony database sms message table
            messageUri = MmsUtils.insertSmsMessage(context,
                    Telephony.Sms.CONTENT_URI,
        ...
        if (messageUri != null && !TextUtils.isEmpty(messageUri.toString())) {
            ...
            try {
                ...
                //Bkav QuangNDb them logic iccid
                if (iccid == null) {
                    iccid = PhoneUtils.getDefault().getDefaultSmsIccid(subId);
                }
                ...
                SendBroadcastUnreadMessage.sendLocalBroadCast(context,db);
