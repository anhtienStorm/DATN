...
public class MessagePartData implements Parcelable {
    ...
    // Bkav QuangNDb them index cot text search, tang cot CONVERSATION_ID nen 1 don vi(7-8)
    private static final int INDEX_TEXT_SEARCH = 7;
    ...
    // Bkav QuangNDb sua lai cau lenh insert de them cot text search vao
     ...
     */
    public MessagePartData(final String messageText) {
    ...
    public SQLiteStatement getInsertStatement(final DatabaseWrapper db,
        ...
        if (mText != null) {
            ...
            // BKav QuangNDb them insert vao cot text search
            insert.bindString(INDEX_TEXT_SEARCH, convertToNotLatinCode(mText));
        }
        if (mContentUri != null) {
    ...
    */
     ...
     */
    private String convertToNotLatinCode(String latinCode){
        String result = Normalizer.normalize(latinCode, Normalizer.Form.NFKD).replaceAll(
