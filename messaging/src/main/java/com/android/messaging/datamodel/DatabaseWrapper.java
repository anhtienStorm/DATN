...
public class DatabaseWrapper {
    ...
    /**Bkav QuangNDb cap nhat lai bang fts conversation*/
    public void rebuildFtsConversationTable() {
        mDatabase.execSQL("INSERT INTO "+ DatabaseHelper.FTS_CONVERSATIONS_TABLE+"("+DatabaseHelper.FTS_CONVERSATIONS_TABLE+") VALUES('rebuild')");
    }
