...
public class AudioRecordView extends FrameLayout implements
    ...
    protected void onFinishInflate() {
        ...
        // Bkav HienDTk: fix loi - BOS-3261 - Start
        int width_record = getResources().getDimensionPixelOffset(R.dimen.width_record);
        // Bkav HienDTk: neu la BL01 thi moi cho custom lai icon ghi am
        if(DeviceVersionUtil.isBL01Device()){
            mRecordButtonVisual.setLayoutParams(new FrameLayout.LayoutParams(width_record, width_record));
        }
        // Bkav HienDTk: fix loi - BOS-3261 - End
    ...
    private void updateRecordButtonAppearance() {
        ...
        if (isRecording()) {
            foregroundDrawable.setColorFilter(getColorRecording(), PorterDuff.Mode.SRC_ATOP);
            backgroundDrawable.setColor(getColorIdle());
        } else {
            foregroundDrawable.setColorFilter(getColorIdle(), PorterDuff.Mode.SRC_ATOP);
            backgroundDrawable.setColor(getColorRecording());
        }
    ...
    /**
     * -------------------------------------------------------BKAV--------------------------------------------------------
     * Bkav QuangNDb get color luc chua ghi am
     */
    ...
    /**
     * Bkav QuangNDb get color luc dang ghi am ghi am
     */
