 ...
 */
public class CameraMediaChooser extends MediaChooser implements
    ...
    protected View mEnabledView;
    protected View mMissingPermissionView;

    public CameraMediaChooser(final MediaPicker mediaPicker) {
        super(mediaPicker);
    }
    ...
    protected View createView(final ViewGroup container) {
        ...
        final CameraMediaChooserView view = getCameraMediaChooserView(inflater,container);
