...
public class PhoneNumberPreference extends EditTextPreference {
    ...
    protected void onBindView(final View view) {
        ...
        final String displayValue = (!TextUtils.isEmpty(value))
                ...
                : getContext().getString(R.string.sim_settings_unknown_number);//HienDTk: thay doi text cho sdt khong xac dinh
    ...
    protected void onBindDialogView(final View view) {
        ...
        // Bkav HienDTk: show keyboard khi hien thi popup nhap sdt
        ImeUtil.get().showImeKeyboard(Factory.get().getApplicationContext(), getEditText());
