...
public abstract class MediaChooser extends BasePagerViewHolder
    ...
    void updateActionBar(final ActionBar actionBar) {
        ...
        if (actionBarTitleResId == 0) {
            ...
            // Bkav HienDTk: fix loi Lỗi: Hiển thị text "Da..." bên cạnh placehoder Tìm kiếm danh bạ trên giao diện Tìm kiếm danh bạ khi máy để kích thước phông chữ/kích thước hiển thị nhỏ nhất => BOS-2659 - Start
            ...
            // Bkav HienDTk: fix loi Lỗi: Hiển thị text "Da..." bên cạnh placehoder Tìm kiếm danh bạ trên giao diện Tìm kiếm danh bạ khi máy để kích thước phông chữ/kích thước hiển thị nhỏ nhất => BOS-2659 - End
