...
public class SimSelectorItemView extends LinearLayout {
    ...
    protected SubscriptionListEntry mData;
    private TextView mNameTextView;
    private TextView mDetailsTextView;
    protected SimIconView mSimIconView;
    ...
    private static final String TAG = "SimSelectorItemView";
    @Override
    ...
    //---------------------------------------------------------BKAV------------------------------------
    /**
     * QuangNDb gui su kien up den thang sim de no cap nhat lai back ground
     */
    protected void sendEventTouchSimIcon() {

    }

    /**Bkav QuangNDb set uri cho sim icon*/
    protected void setUriSimIconView() {
        mSimIconView.setImageResourceUri(mData.iconUri);
    }

    /**Bkav QuangNDb khoi tao init simIconView*/
