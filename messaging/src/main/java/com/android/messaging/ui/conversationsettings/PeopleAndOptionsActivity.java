...
public class PeopleAndOptionsActivity extends BugleActionBarActivity {
    ...
    //---------------------------------------------------------BKAV------------------------------
    /**
     * Bkav QuangNDb get id layout res custom lai o class con
     */
    protected int getIdLayoutRes() {
        return R.layout.people_and_options_activity;
    }

    /**
     * Bkav QuangNDb change color actionbar
     */
    protected void changeActionbarColor() {
        // Bkav khong lam gi custom lai o class con
    }
}
