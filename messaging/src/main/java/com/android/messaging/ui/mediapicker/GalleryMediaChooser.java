 ...
 */
public class GalleryMediaChooser extends MediaChooser implements
        GalleryGridView.GalleryGridViewListener, MediaPickerDataListener {
    private final GalleryGridAdapter mAdapter;
    protected GalleryGridView mGalleryGridView;
    protected View mMissingPermissionView;

    public GalleryMediaChooser(final MediaPicker mediaPicker) {
        super(mediaPicker);
    ...
    protected View createView(final ViewGroup container) {
        ...
        // Bkav QuangNDb tach code doan get Gallery view
        mGalleryGridView = getGalleryView(view);
        ...
        initAppSettingButton(view);//Bkav QuangNDb them nut app settings
        return view;
    }
    ...
    /**
     * --------------------------------------------------------------Bkav-------------------------------------------------
     * Bkav QUangNDb tach code doan get Id layout res
     */
    protected int getIdLayoutRes() {
        return R.layout.mediapicker_image_chooser;
    }

    /**
     * Bkav QuangNDb tach code doan getGalleryView
     */
    protected GalleryGridView getGalleryView(View view) {
        return (GalleryGridView) view.findViewById(R.id.gallery_grid_view);
    }
}
