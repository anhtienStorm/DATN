 ...
 */
public class AudioMediaChooser extends MediaChooser implements
        AudioRecordView.HostInterface {
    private View mEnabledView;
    private View mMissingPermissionView;

    public AudioMediaChooser(final MediaPicker mediaPicker) {
        super(mediaPicker);
    }
    ...
    protected View createView(final ViewGroup container) {
        ...
        final AudioRecordView view = getAudioRecordView(inflater,container);
    ...
    public void onResume() {
        if (mEnabledView != null && mMissingPermissionView != null) {
            mEnabledView.setVisibility(OsUtil.hasRecordAudioPermission() ? View.VISIBLE : View.GONE);
            mMissingPermissionView.setVisibility(OsUtil.hasRecordAudioPermission() ? View.GONE : View.VISIBLE);
        }
    }
