...
public class MediaPicker extends Fragment implements DraftMessageSubscriptionDataProvider {
    ...
    protected MediaChooser[] mChoosers;

    /** The list of currently enabled choosers */
    protected final ArrayList<MediaChooser> mEnabledChoosers;

    /** The currently selected chooser */
    protected MediaChooser mSelectedChooser;
    ...
    public MediaPicker(final Context context) {
        ...
        // Bkav QuangNDb tach code doan init chooser der override lai o class con
        initChooser();
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        // Bkav QuangNDb them context vao loi goi ham de custom doan xu ly
        mDocumentImagePicker.onActivityResult(requestCode, resultCode, data, getActivity());
    }
...
//            actionBar.hide();
     ...
     */
    public void selectChooser(final MediaChooser newSelectedChooser) {
    ...
    public void dispatchItemsSelected(final MessagePartData item, final boolean dismissMediaPicker) {
    ...
    /**
     * ----------------------------------------------------------------Bkav--------------------------------------------------
     * BKav QuangNDb tach code doan init chooser ra de override lai o class con
     */
