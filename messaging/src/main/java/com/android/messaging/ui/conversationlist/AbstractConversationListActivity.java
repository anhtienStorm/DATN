...
public abstract class AbstractConversationListActivity  extends BugleActionBarActivity
    ...
    public static class UpdateDestinationBlockedActionSnackBar
        ...
        public UpdateDestinationBlockedActionSnackBar(final Context context,
        ...
        public void onUpdateDestinationBlockedAction(
            ...
            if (success) {
                ...
                // Bkav HienDTk: cap nhat notification khi unblock
                updateNotification(destination, mContext, block);
    ...
    // Bkav HaiKH - Fix bug BOS-3729- Start
    // Thêm biến block để update âm báo tin nhắn cho đúng
    // Bkav HienDTk: fix bug - BOS-3166 - Start
    // Bkav HienDTk: query lay conversationId de update lai thong bao.
    public static void updateNotification(String phone, Context context, boolean block){
        Cursor cursor = context.getContentResolver().query(MessagingContentProvider.CONVERSATIONS_URI, ConversationListItemData.PROJECTION, ConversationListItemData.ConversationListViewColumns.OTHER_PARTICIPANT_NORMALIZED_DESTINATION + "=?", new String[]{phone}, null);
        if(cursor != null){
    ...
    // Bkav HienDTk: fix bug - BOS-3166 - End
    // Bkav HaiKH - Fix bug BOS-3729- End
    ...
    //===============================================================BKAV=================================================
    /**
     * Bkav QuangNDb them ham khoi tao fragment de custom lai o class con
     */
