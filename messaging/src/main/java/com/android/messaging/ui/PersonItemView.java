...
public class PersonItemView extends LinearLayout implements PersonItemDataListener,
    ...
    public void setListener(final PersonItemViewListener listener) {
      ...
      final OnClickListener setOnClickListener = new OnClickListener() {
            @Override
        ...
        // Bkav HaiKH - Fix bug BOS-3725- Start
        // Bắt sự kiện click vào item liên hệ
        setOnClickListener(setOnClickListener);
        // Bkav HaiKH - Fix bug BOS-3725- End
        mContactIconView.setOnLongClickListener(onLongClickListener);
        // Bkav HienDTk: set su kien click vao icon avatar trong phan cai dat => BOS-1472 - Start
        mContactIconView.setOnClickListener(setOnClickListener);
        // Bkav HienDTk: set su kien click vao icon avatar trong phan cai dat => BOS-1472 - Start
    ...
    /**
     * HienDTk: lay lookupKey
     */
    public String getLookupKey(){
        return mBinding.getData().getLookupKey();
    }
    /**
     * HienDTk: lay id contact
     */
    public long getContactID(){
        return mBinding.getData().getContactId();
    }
    /**
     * HienDTk: lay so dien thoai
     */
