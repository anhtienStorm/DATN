...
public class PeopleAndOptionsFragment extends Fragment
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        // Bkav QuangNDb add footer view vao list option
    ...
    public void onOptionsItemViewClicked(final PeopleOptionsItemData item,
        ...
        switch (item.getItemId()) {
            ...
            case PeopleOptionsItemData.SETTING_NOTIFICATION_SOUND_URI:
                ...
                // QuangNDb them chooser de bo just one always
                Intent intent = Intent.createChooser(ringtonePickerIntent, null);
...
//                break;
                ...
                new AlertDialog.Builder(activity)
                        ...
                        .setPositiveButton(android.R.string.ok,
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                // Bkav HienDTk: update notification khi chan tin nhan
                                UpdateConversationOptionsAction.enableConversationNotifications(
                                        mBinding.getData().getConversationId(), false);
    ...
    /**
     * HienDTk: dung interface lang nghe su kien click vao item lien he
     */
    public interface onClickListener{
        void onClick(String lookupKey, long id, String number);
    }
        ...
        public View getView(final int position, final View convertView, final ViewGroup parent) {
            ...
            itemView.setListener(new PersonItemView.PersonItemViewListener() {
                ...
                public void onPersonClicked(final PersonItemData data) {
                    listener.onClick(itemViewClosure.getLookupKey(), itemViewClosure.getContactID(), itemViewClosure.getNumber());
