...
public class MultiAttachmentLayout extends FrameLayout {
    ...
    private void buildViews(final Iterable<MessagePartData> attachments,
        ...
        while (iterator.hasNext() && i < count) {
            ...
            // layout
            if (i == 0) {
                // tach code doan animate view in
                animateViewIn(attachment,attachmentWrapper);
            }
    ...
    /**
     * Bkav QuangNDb animate view in
     */
    protected void animateViewIn(MessagePartData attachment, ViewWrapper attachmentWrapper) {
