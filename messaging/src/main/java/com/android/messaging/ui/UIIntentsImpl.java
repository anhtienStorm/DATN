...
public class UIIntentsImpl extends UIIntents {
    ...
    // Bkav HienDTk: intent bat ban phim conversation
    public static final String FLAG_SEND_TO = "message_send_to";

    public static final String ID_CONVERSATION_SEND_MESSAGE_IN_APP = "7";
     ...
     */
    protected Intent getConversationActivityIntent(final Context context,
            final String conversationId, final MessageData draft,
            final boolean withCustomTransition) {
        final Intent intent = conversationIntent(context);

        // Bkav HienDTk: neu nhan mo conversation trong app thi gui intent bat ban phim

        if(conversationId != null && conversationId.equals(ID_CONVERSATION_SEND_MESSAGE_IN_APP)){
            intent.putExtra(FLAG_SEND_TO, SHOW_KEYBOARD);
        }
     ...
     */
    protected Intent getConversationListActivityIntent(final Context context) {
    ...
    public void launchDocumentImagePicker(final Fragment fragment) {
        // Bkav QuangNDb mo duyet file mo album anh ra tu day
    ...
    public void launchClassZeroActivity(final Context context, final ContentValues messageValues) {
        final Intent classZeroIntent = new Intent(context, ClassZeroActivity.class)
                ...
                // Bkav TienNAb: fix loi khi hien thi thong bao chuyen mang giu so thi thoat giao dien cuoc goi
                .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK |Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
    ...
    public void launchFullScreenPhotoViewer(final Activity activity, final Uri initialPhoto,
        ...
        final PhotoViewIntentBuilder builder =
                com.android.ex.photo.Intents.newPhotoViewIntentBuilder(
                        activity, returnBuglePhotoViewActitivty()/*Bkav TrungTH them vao*/);
     ...
     */
    protected void startExternalActivity(final Context context, final Intent intent) {
        try {
            context.startActivity(intent);
    ...
    protected Intent getPerSubscriptionSettingsIntent(final Context context, final int subId,
    ...
    /**
     * ----------------------------------------------------BKAV------------------------------------------------------------
     * Bkav QuangNDb: them ham init intent de ben lop con co the override lai
     */
    ...
    protected Class<? extends Activity> returnBuglePhotoViewActitivty(){
        return BuglePhotoViewActivity.class;
    }
