...
public class MessageBubbleBackground extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Bkav TienNAb: sua lai chieu dai max cua tin nhan theo thiet ke
        final int maxWidth = MeasureSpec.getSize(widthMeasureSpec) - widthPadding - getResources().getDimensionPixelOffset(R.dimen.width_message_reduction);
