...
public class PerSubscriptionSettingsActivity extends BugleActionBarActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // Bkav QuangNDb them ham set elevation cho action bar
        setElevationActionbar();
        final FragmentTransaction ft = getFragmentManager().beginTransaction();
        // Bkav QuangNDb tach source code doan init fragment de override lai o class con
        final PerSubscriptionSettingsFragment fragment = getFragment(title);
    ...
    public static class PerSubscriptionSettingsFragment extends PreferenceFragment
            ...
            if (!MmsConfig.get(mSubId).getGroupMmsEnabled()) {
                ...
                mGroupMmsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference pref) {
                        showDialogOptionMMSGroup(mSubId);
                        return true;
                    }
                });
        ...
        private void updateGroupMmsPrefSummary() {
            // Bkav QuangNDb tach code doan getDeafult MMS group message
            final boolean groupMmsEnabled = getPreferenceScreen().getSharedPreferences().getBoolean(
                    mGroupMmsPrefKey, getResources().getBoolean(getIdResMMSGroupMessageDefault()));
        ...
        /**
         * ---------------------------------------------------------BKAV----------------------------------
         * Bkav QuangNDb tach code doan getId MMS group message
         */
        protected int getIdResMMSGroupMessageDefault() {
            return R.bool.group_mms_pref_default;
        }

        /**
         * Bkav QuangNDb tach code doan show dialog option mms group
         */
    ...
    /**
     * ---------------------------------------------------------BKAV----------------------------------
     * Bkav QuangNDb tach code doan get fragment de override lai o class con
     */
    protected PerSubscriptionSettingsFragment getFragment(String title) {
        return new PerSubscriptionSettingsFragment();
    }
    ...
    /**
     * Bkav QuangNDb tach code doan set elavation actionbar
     */
