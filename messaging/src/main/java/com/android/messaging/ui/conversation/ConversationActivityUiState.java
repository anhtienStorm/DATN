...
import com.android.messaging.util.LogTime;
...
public class ConversationActivityUiState implements Parcelable, Cloneable {
    ...
    // Bkav QuangNDb them trang thai co the them nguoi vao conversation
    public static final int STATE_CONVERSATION_ONLY_AND_CAN_ADD_MORE_PARTICIPANTS = 6;

    // Bkav QuangNDb them trang thai create group
    public static final int STATE_CREATE_GROUP_CONVERSATION = 7;

    // The overall UI state of the ConversationActivity.
    protected int mConversationContactUiState;
    ...
    public ConversationActivityUiState(final String conversationId) {
        ...
        mConversationContactUiState = getFirstState(conversationId);
    }
    ...
    public int getDesiredContactPickingMode() {
        switch (mConversationContactUiState) {
            ...
            case STATE_CREATE_GROUP_CONVERSATION:
                return ContactPickerFragment.MODE_CREATE_GROUP_PARTICIPANTS;
            default:
    ...
    public void performUiStateUpdate(final int conversationContactState, final boolean animate) {
    ...
    /**
     * ---------------------------------------------------Bkav---------------------------------------------------
     * Bkav QuangNDb: Them chuc nang get trang thai lai
     */
    public int getState() {
    ...
    /**
     * Bkav QuangNDb: them ham set state cho ui state
     */
    public void setConversationContactUiState(int conversationContactUiState) {
        this.mConversationContactUiState = conversationContactUiState;
    }

    /**
     * Bkav QuangNDb: Them chuc nang add more contact o lop bkav custom lai
     */
    public void onAddMoreContact(){
        //BkavQuangNdb khong lam gi
    }

    /**
     * BKav QUangNDb: them ham check trang thai add more contact
     */
    ...
    /**
     * Bkav QUangNDb get first state conversation
     */
