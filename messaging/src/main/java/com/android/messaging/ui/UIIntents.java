...
public abstract class UIIntents {
    ...
    /**Bkav QuangNDb launch hien thi BtalkPermission activity*/
    public abstract void launchBtalkPermissionCheckActivity(final Context context);
    ...
    /**
     * Bkav QuangNDb create group conversation activity
     * Launch an activity to start a group conversation
     */
    ...
    /**
     * Bkav TienNAb: start activity de chon danh ba add vao danh sach yeu thich
     */
    public abstract void launchAddFavoriteContactListActivity(final Context context);
    ...
    //==============================================================bkav================================================
    /**
     * Bkav QuangNDb them ham show conversation khi search tin nhan
     */
    /**
     * Launch an activity to show a conversation.
     */
    public abstract void launchConversationActivitySearch(final Context context,
                                                    final String conversationId, final MessageData draft, final Bundle activityOptions,
                                                    final boolean withCustomTransition, int messagePos);

    public abstract void makeACall(Context context, FragmentManager fragmentManager, String number);

    public abstract void showListEsimLongClick(Context context, FragmentManager fragmentManager, String number);

    public abstract void makeACall(Context context, FragmentManager fragmentManager, Intent intent);
    //Bkav QuangNDb yeu cau giao dien cuoc goi di fake, dung cho truong hop goi bang profile chua activate cua eSim
    public abstract void requestFakeCall(String number, Fragment fragment, int simIndex);

    public abstract void launchBtalkQuickResponseEditActivity(Context context);
}
