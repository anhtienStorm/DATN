...
public class AudioAttachmentPlayPauseButton extends ViewSwitcher {
    ...
    private void updateAppearance() {
        // Bkav QuangNDb tach code doan khoi tao ConversationDrawables
        mPlayButton.setImageDrawable(getConversationDrawables()
                .getPlayButtonDrawable(mShowAsIncoming));
        mPauseButton.setImageDrawable(getConversationDrawables()
                .getPauseButtonDrawable(mShowAsIncoming));
    }

    /**
     * ---------------------------------BKAV-------------------------------------------
     * BKav QuangNDb: them ham getConversationDrawables tach code de override lai o class con
     */
