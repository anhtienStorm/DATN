...
public class MediaPickerPanel extends ViewGroup {
    ...
    public MediaPickerPanel(final Context context, final AttributeSet attrs) {
        ...
        mActionBarHeight = getResources().getDimensionPixelSize(R.dimen.action_bar_height_fix);
        // Bkav TienNAb: goi ham thay doi chieu cao mediapicker theo chieu cao ban phim
        setHeightAccordingToKeyboard();
    }
    ...
    // Bkav TienNAb: ham set chieu cao mediapicker bang chieu cao ban phim
    private void setHeightAccordingToKeyboard(){
        // Bkav TienNAb: lang nghe su kien chieu cao ban phim thay doi
        getRootView().getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (keypadHeight > 0){
                    mDefaultViewPagerHeight = keypadHeight - mTabStrip.getMeasuredHeight();
                }
            }
        });
    }
