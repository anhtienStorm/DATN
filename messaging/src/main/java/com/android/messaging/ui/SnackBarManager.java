...
public class SnackBarManager {
    ...
    public void show(final SnackBar snackBar) {
        ...
        if (placement == null) {
            ...
            // Bkav HaiKH - Fix bug BOS-3097- Start
            // Nếu thanh điều hướng đang được sử dụng thì setLocation cho snackBar lên trên nó.
            if(hasNavigationBar()){
                mPopupWindow.showAtLocation(
                        snackBar.getParentView(), Gravity.BOTTOM| Gravity.START,
                        0,getHeightOfNavigationBar(snackBar.getContext()));
                // Bkav HaiKH - Fix bug BOS-3097- End
    ...
    // Bkav HaiKH - Fix bug BOS-3097- Start
    // Đo chiều cao của View điều hướng cơ bản
    ...
    // Sử dụng check NavigationBar có đang hiển thị hay không
