...
public class BuglePhotoViewController extends PhotoViewController {
    private android.support.v7.widget.ShareActionProvider mShareActionProvider; // Bkav TrungTH sua lai import
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ((Activity) getActivity()).getMenuInflater().inflate(initMenuId(), menu);

        // Get the ShareActionProvider
        mShareItem = menu.findItem(R.id.action_share);
        mShareActionProvider = getActionProvider(); // Bkav TrungTh sua lai
        updateShareActionProvider();
    ...
    /**
     * Bkav TrungTh them ham chuyen sang compart de chay duoc
     * @return
     */
    @Nullable
    protected android.support.v7.widget.ShareActionProvider getActionProvider() {
        return (android.support.v7.widget.ShareActionProvider) MenuItemCompat.getActionProvider(mShareItem);
    }

    /**
     * Bkav TrungTH: ghi de viec menu
     * @return
     */
    protected int initMenuId(){
        return R.menu.photo_view_menu;
    }
}
