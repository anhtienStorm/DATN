...
public class LineWrapLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int maxLineWidth = 0;
        int numberChildViewVisible = 0;     // Bkav TienNAb: check so luong view con dang hien thi
        int metadataTopPadding = getResources().getDimensionPixelOffset(
        ...
        // Bkav TienNAb: bo padding neu khong co view con nao hien thi
        if (numberChildViewVisible == 0){
            setPadding(getPaddingLeft(),0,getPaddingRight(),getPaddingBottom());
        }else {
            setPadding(getPaddingLeft(),metadataTopPadding,getPaddingRight(),getPaddingBottom());
        }
