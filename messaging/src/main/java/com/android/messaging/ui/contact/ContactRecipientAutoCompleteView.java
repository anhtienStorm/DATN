...
public class ContactRecipientAutoCompleteView extends RecipientEditTextView {
    public interface ContactChipsChangeListener {
        ...
        // Quangndb them interface dan so dien thoai
        boolean onPasteParticipant(String participants);
        //Bkav QuangNDb them interface change focus o nhap lien he
        void onResumeRequest();
        void onInsertEntry(RecipientEntry recipientEntry);
        void onRemoveEntry(RecipientEntry recipientEntry);
    }

    private final int mTextHeight;
    protected ContactChipsChangeListener mChipsChangeListener;
     ...
     */
    public void sanitizeContactChips() {
    ...
    public ArrayList<ParticipantData> getRecipientParticipantDataForConversationCreation() {
        ...
        // TODO: 25/08/2017 Doan code nay lam delay mat 86s, do ban dau da sanitize khi khoi tao r
//        sanitizeContactChips();
    ...
    /**
     * -----------------------------------------------Bkav------------------------
     * Bkav QuangNDb get sdt da them va khong kem ma nuoc
     */
    ...
    /**
     * Bkav QUangNDb tach code doan get drawable cua background
     */
