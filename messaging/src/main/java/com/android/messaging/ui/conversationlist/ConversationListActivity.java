...
public class ConversationListActivity extends AbstractConversationListActivity {
    ...
    public boolean onOptionsItemSelected(final MenuItem menuItem) {
        ...
        if (i == R.id.action_start_new_conversation) {
            onActionBarStartNewConversation();
            return true;
        } else if (i == R.id.action_settings) {
            onActionBarSettings();
            return true;
        } else if (i == R.id.action_debug_options) {
            onActionBarDebug();
            return true;
        } else if (i == R.id.action_show_archived) {
            onActionBarArchived();
            return true;
        } else if (i == R.id.action_show_blocked_contacts) {
