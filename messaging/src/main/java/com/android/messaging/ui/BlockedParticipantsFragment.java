...
public class BlockedParticipantsFragment extends Fragment
    ...
    protected final Binding<BlockedParticipantsData> mBinding =
    ...
    public class BlockedParticipantListAdapter extends CursorAdapter {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            return LayoutInflater.from(context)
                    .inflate(getIdResLayout(), parent, false);
        }

        @Override
        public void bindView(View view, Context context, Cursor cursor) {
            binAdapterView(view,cursor);
        }
        /**
         * Bkav QuangNDb tach code doan get Res layout
         */
        protected int getIdResLayout() {
            return R.layout.blocked_participant_list_item_view;
        }
        /**
         * Bkav QuangNDb tach code doan bin adapter view
         */
    ...
    /**
     * ---------------------------------------------------------------Bkav-------------------------------------
     * Bkav QuangNDb tach code doan init adapter
     */
    protected BlockedParticipantListAdapter getAdapter() {
        return new BlockedParticipantListAdapter(getActivity(), null);
    }
}
