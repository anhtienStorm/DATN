...
public class AttachmentPreview extends ScrollView implements OnAttachmentClickListener {
    ...
    public boolean onAttachmentsChanged(final DraftMessageData draftMessageData) {
        ...
        if (combinedAttachmentCount > 1) {
            ...
            if (attachmentView != null) {
                ...
                if (shouldAnimate) {
                    animateViewIn(attachment, attachmentView);
                }
            }
        }
        return true;
    ...
    public static void tryAnimateViewIn(final MessagePartData attachmentData, final View view) {
    ...
    /**
     * Bkav QuangNDb tach code doan animateViewIndeOverride lai
     */
