...
public class ArchivedConversationListActivity extends AbstractConversationListActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final ConversationListFragment fragment = setUpFragment();
    ...
    protected void updateActionBar(ActionBar actionBar) {
        ...
        changeColorActionBar(actionBar);
        actionBar.show();
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (i == R.id.action_debug_options) {
            onActionBarDebug();
            return true;
    ...
    /**
     * -------------------------------------------------------Bkav------------------------------------------------------
     * Bkav QuangNDb: ham nay la de tach doan code setcolor cho action bar de custom lai o lop con
     */
    ...
    /**
     * Bkav QuangNDb: tach code doan setup fragment de override lai o lop con
     */
    protected ConversationListFragment setUpFragment() {
        return ConversationListFragment.createArchivedConversationListFragment();
    }
}
