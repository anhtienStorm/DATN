...
public class DatabaseMessages {
    ...
    public static class SmsMessage extends DatabaseMessage implements Parcelable {
        ...
        public static final int INDEX_ICCID = sIota++;

        private static final String ICCID_COLUMN = "iccid";//Bkav QuangNDb them cot iccid(chi co trong ROM Bphone)
        ...
        private void load(final Cursor cursor) {
            ...
            mIccid = cursor.getString(INDEX_ICCID);//Bkav QuangNDb them iccid
        }
