...
public class MmsConfig {
    ...
    /**
     * Retrieves the MmsConfig instance associated with the given {@code mSlotId}
     */
    public static MmsConfig get(final int subId) {
        ...
        synchronized (sSubIdToMmsConfigMap) {
            ...
            if (mmsConfig == null) {
                // The mSlotId is no longer valid. Fall back to the default config.
                LogUtil.e(LogUtil.BUGLE_TAG, "Get mms config failed: invalid mSlotId. mSlotId=" + subId
                        + ", real mSlotId=" + realSubId
