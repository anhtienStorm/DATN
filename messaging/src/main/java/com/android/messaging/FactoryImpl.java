...
public class FactoryImpl extends Factory {
    protected BugleApplication mApplication;
    protected DataModel mDataModel;
    protected BugleGservices mBugleGservices;
    protected BugleApplicationPrefs mBugleApplicationPrefs;
    protected BugleWidgetPrefs mBugleWidgetPrefs;
    protected Context mApplicationContext;
    protected UIIntents mUIIntents;
    protected MemoryCacheManager mMemoryCacheManager;
    protected MediaResourceManager mMediaResourceManager;
    protected MediaCacheManager mMediaCacheManager;
    protected ContactContentObserver mContactContentObserver;
    protected PhoneUtils mPhoneUtils;
    protected MediaUtil mMediaUtil;
    protected SparseArray<BugleSubscriptionPrefs> mSubscriptionPrefs;
    protected BugleCarrierConfigValuesLoader mCarrierConfigValuesLoader;
    ...
    // Cached mSlotId->instance for L_MR1 and beyond
...
//        Assert.isNull(Factory.get());
    ...
    public PhoneUtils getPhoneUtils(int subId) {
        if (OsUtil.isAtLeastL_MR1()) {
            ...
            if (subId < 0) {
                LogUtil.w(LogUtil.BUGLE_TAG, "PhoneUtils.getForLMR1(): invalid mSlotId = " + subId);
