...
import com.android.messaging.datamodel.action.UpdateUnreadMessageAction;
...
public class BootAndPackageReplacedReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "BootAndPackageReplacedR";
    @Override
    public void onReceive(final Context context, final Intent intent) {
        if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())
            ...
            // QuangNDB them phan update unread message cho lancher
            UpdateUnreadMessageAction.updateUnreadMessageAction();
