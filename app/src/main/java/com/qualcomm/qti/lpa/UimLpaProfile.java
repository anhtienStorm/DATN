...
public class UimLpaProfile implements Parcelable, ISimProfile {
...
//        }
        return profileName+" - "+nickname+" - "+nicknamePresent+ " - "+profileNamePresent+" - "+profileState+" - "+spnName +" - "+profileClass+" - "+profilePolicyMask+" - "+iconType+" - "+ Arrays.toString(iccid) +" - "+ Arrays.toString(icon);
    }
    ...
    public String getSimNameSetting() {
        return simNameSetting;
    }

    private int slot;

    public UimLpaProfile(String nickname, String profileName, byte[] iccid, int slot, int color, boolean profileState, String simNameSetting, int profileIndex) {
        this.nickname = nickname;
        this.profileName = profileName;
        this.iccid = iccid;
        this.slot = slot;
        this.color = color;
        this.profileState = profileState;
        this.simNameSetting = simNameSetting;
        this.mProfileIndex = profileIndex;
    }
}
