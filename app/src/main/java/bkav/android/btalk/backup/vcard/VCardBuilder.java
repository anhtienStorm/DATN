...
public class VCardBuilder {
    ...
    /** The Constant sAllowedAndroidPropertySet. */
    ...
    /** The Constant VCARD_DATA_VCARD. */
    private static final String VCARD_DATA_VCARD = "VCARD";
    
    /** The Constant VCARD_DATA_PUBLIC. */
    private static final String VCARD_DATA_PUBLIC = "PUBLIC";

    /** The Constant VCARD_PARAM_SEPARATOR. */
    private static final String VCARD_PARAM_SEPARATOR = ";";
    
    /** The Constant VCARD_END_OF_LINE. */
    private static final String VCARD_END_OF_LINE = "\r\n";
    
    /** The Constant VCARD_DATA_SEPARATOR. */
    private static final String VCARD_DATA_SEPARATOR = ":";
    
    /** The Constant VCARD_ITEM_SEPARATOR. */
    private static final String VCARD_ITEM_SEPARATOR = ";";
    
    /** The Constant VCARD_WS. */
    private static final String VCARD_WS = " ";
    
    /** The Constant VCARD_PARAM_EQUAL. */
    private static final String VCARD_PARAM_EQUAL = "=";

    /** The Constant VCARD_PARAM_ENCODING_QP. */
    private static final String VCARD_PARAM_ENCODING_QP = "ENCODING=QUOTED-PRINTABLE";

    /** The Constant VCARD_PARAM_ENCODING_BASE64_V21. */
    private static final String VCARD_PARAM_ENCODING_BASE64_V21 = "ENCODING=BASE64";
    
    /** The Constant VCARD_PARAM_ENCODING_BASE64_V30. */
    ...
    /** The m is japanese mobile phone. */
    private final boolean mIsJapaneseMobilePhone;
    
    /** The m only one note field is available. */
    private final boolean mOnlyOneNoteFieldIsAvailable;
    
    /** The m is do co mo. */
    private final boolean mIsDoCoMo;
    
    /** The m should use quoted printable. */
    private final boolean mShouldUseQuotedPrintable;
    
    /** The m uses android property. */
    private final boolean mUsesAndroidProperty;
    
    /** The m uses defact property. */
    ...
    /** The m append type param name. */
    private final boolean mAppendTypeParamName;
    
    /** The m refrains qp to name properties. */
    private final boolean mRefrainsQPToNameProperties;
    
    /** The m needs to convert phonetic string. */
    private final boolean mNeedsToConvertPhoneticString;

    /** The m should append charset param. */
    private final boolean mShouldAppendCharsetParam;

    /** The m charset string. */
    private final String mCharsetString;
    
    /** The m v card charset parameter. */
    ...
    /**
     * Instantiates a new v card builder.
     *
    ...
    /**
     * Gets the primary content value.
     *
     * @param contentValuesList the content values list
     * @return the primary content value
     */
    ...
    /** The Constant sPostalTypePriorityMap. */
    private static final SparseIntArray sPostalTypePriorityMap;

    static {
        sPostalTypePriorityMap = new SparseIntArray();
    ...
    /**
     * The Class PostalStruct.
     */
    private static class PostalStruct {
        
        /** The really use quoted printable. */
        final boolean reallyUseQuotedPrintable;
        ...
        /**
         * Instantiates a new postal struct.
         *
         * @param reallyUseQuotedPrintable the really use quoted printable
         * @param appendCharset the append charset
     ...
     * @param emitLineEveryTime the emit line every time
     */
     ...
     * Append tel line.
     *
     * @param typeAsInteger the type as integer
     * @param label the label
    ...
    /**
     * Append android specific property.
     *
    ...
    /**
     * Append line with charset and qp detection.
     *
     ...
     *
     * @param propertyName the property name
     * @param rawValueList the raw value list
     */
     ...
     * @param propertyName the property name
     * @param rawValue the raw value
     * @param needCharset the need charset
     * @param reallyUseQuotedPrintable the really use quoted printable
     */
     ...
     * @param rawValueList the raw value list
     * @param needCharset the need charset
     * @param needQuotedPrintable the need quoted printable
     */
    public void appendLine(final String propertyName, final List<String> rawValueList,
