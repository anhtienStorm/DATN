...
public class VCardParser_V21 extends VCardParser {
    ...
    /** The m time read start record. */
    private long mTimeReadStartRecord;
    
    /** The m time read end record. */
    private long mTimeReadEndRecord;
    
    /** The m time start property. */
    @SuppressWarnings("unused")
	private long mTimeStartProperty;
    
    /** The m time end property. */
    @SuppressWarnings("unused")
	private long mTimeEndProperty;
    
    /** The m time parse items. */
    @SuppressWarnings("unused")
	private long mTimeParseItems;
    
    /** The m time parse line and handle group. */
    private long mTimeParseLineAndHandleGroup;
    
    /** The m time parse property values. */
    private long mTimeParsePropertyValues;
    
    /** The m time parse adr org n. */
    private long mTimeParseAdrOrgN;
    
    /** The m time handle misc property value. */
    private long mTimeHandleMiscPropertyValue;
    
    /** The m time handle quoted printable. */
    private long mTimeHandleQuotedPrintable;
    
    /** The m time handle base64. */
    private long mTimeHandleBase64;

    /**
     * Instantiates a new v card parser_ v21.
     */
    ...
    /**
     * Checks if is valid property name.
     *
     ...
     * "END" [ws] ":" [ws] "VCARD".
     *
     * @param firstReading the first reading
     ...
     *
     * @param pvalueval the pvalueval
     */
    protected void handleValue(final String pvalueval) {
        if (!sKnownValueSet.contains(pvalueval.toUpperCase(Locale.getDefault())) &&
     ...
     *
     * @param pencodingval the pencodingval
     * @throws VCardException the v card exception
     */
     ...
     *
     * @param charsetval the charsetval
     */
    ...
    protected void handlePropertyValue(String propertyName, String propertyValue)
            throws IOException, VCardException {
        if (mEncoding != null && mEncoding.equalsIgnoreCase("QUOTED-PRINTABLE")) {
        ...
        } else if (mEncoding != null && (mEncoding.equalsIgnoreCase("BASE64") ||
            ...
            if (!(mEncoding == null || mEncoding.equalsIgnoreCase("7BIT")
                    ...
                    || mEncoding.toUpperCase(Locale.getDefault()).startsWith("X-"))) {
    ...
    /**
     * Gets the quoted printable.
     *
     * @param firstString the first string
     * @return the quoted printable
     * @throws IOException Signals that an I/O exception has occurred.
     * @throws VCardException the v card exception
     */
    ...
    protected void handleAgent(final String propertyValue) throws VCardException {
        if (!propertyValue.toUpperCase(Locale.getDefault()).contains("BEGIN:VCARD")) {
    ...
    /* (non-Javadoc)
     * @see bms.backup.VCardParser#parse(java.io.InputStream, bms.backup.VCardInterpreter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see bms.backup.VCardParser#parse(java.io.InputStream, java.lang.String, bms.backup.VCardInterpreter)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see bms.backup.VCardParser#parse(java.io.InputStream, java.lang.String, bms.backup.VCardInterpreter, boolean)
     */
    @Override
