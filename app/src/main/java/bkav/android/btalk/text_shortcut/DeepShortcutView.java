 ...
 */
public class DeepShortcutView extends RelativeLayout implements ValueAnimator.AnimatorUpdateListener, View.OnClickListener {

    private static final Point sTempPoint = new Point();

    private final Rect mPillRect;

    private DeepShortcutTextView mTextView;
    private ImageView mIconView;
    private float mOpenAnimationProgress;
    private DeepShortcutsContainer mDeepShortcutsContainer;
    
    private ActionItem mInfo;
    ...
    protected void onFinishInflate() {
        ...
        mIconView = (ImageView) findViewById(R.id.deep_shortcut_icon);
        mTextView = (DeepShortcutTextView) findViewById(R.id.deep_shortcut);
...
//        return false;
    ...
    /** package private **/
    void applyShortcutInfo(ActionItem info, DeepShortcutsContainer container) {
        mInfo = info;
        mIconView.setImageDrawable(info.getIcon());

        CharSequence longLabel = info.getTitle();
        mTextView.setText(longLabel);

        // QuangNHe
        mDeepShortcutsContainer = container;
        this.setOnClickListener(this);
        
        mTextView.setOnTouchListener(container);
    }
...
//        return null;
    ...
    public Animator createOpenAnimation(boolean isContainerAboveIcon, boolean pivotLeft) {
        ...
        ValueAnimator openAnimator =  new ZoomRevealOutlineProvider(center.x, center.y,
                mPillRect, this, mTextView, isContainerAboveIcon, pivotLeft)
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.deep_shortcut_icon) {
            mDeepShortcutsContainer.onEditClick(mInfo.getQuickResponseData());
        }else {
            mDeepShortcutsContainer.onItemClick(mInfo.getQuickResponseData());
        }
    }
