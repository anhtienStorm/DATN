...
public class SettingsUtil  {
    ...
    public static void updateRingtoneName(
        ...
        if(context != null){
            // Anhdts them 2 type la sim 1 va sim 2
            if (type == RingtoneManager.TYPE_RINGTONE || type == 8 || type == 16) {
                ...
                if (TextUtils.isEmpty(uriString)) {
                    ...
                    if (uriString.equals(DEFAULT_NOTIFICATION_URI_STRING)) {
                        // If it turns out that the voicemail notification is set to0 the system
