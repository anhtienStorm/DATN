...
public class DialpadView extends LinearLayout {
    ...
    protected ImageButton mAddNewContact; // Bkav HuyNQN xu ly them so moi
    protected View mOverflowMenuButton;
    public ColorStateList mRippleColor;

    protected ViewGroup mRateContainer;
    protected TextView mIldCountry;
    protected TextView mIldRate;

    protected boolean mCanDigitsBeEdited;

    protected final int[] mButtonIds = new int[]{R.id.zero, R.id.one, R.id.two, R.id.three,
    ...
    protected void onFinishInflate() {
        ...
        mAddNewContact = (ImageButton) findViewById(R.id.add_new_contact); // Bkav HuyNQN xu ly them so dien thoai moi
    ...
    protected void setupKeypad() {
        ...
        for (int i = 0; i < mButtonIds.length; i++) {
            ...
            final RippleDrawable rippleBackground = (RippleDrawable)
                    getDrawableCompat(getContext(), getRippleDrawableId());
    ...
    public Drawable getDrawableCompat(Context context, int id) {
    ...
    public void setCanDigitsBeEdited(boolean canBeEdited) {
        View addContactButton = findViewById(R.id.add_new_contact);
    ...
    // Bkav HuyNQN lay ra doi tuong them moi so dien thoai
    public ImageButton getAddContactButton() {
        return mAddNewContact;
    }
    ...
    /**********************BKAV*************************/
    // Anhdts custom lai hieu ung an
    protected int getRippleDrawableId() {
        return R.drawable.btn_dialpad_key;
    }

    // Bkav TrungTH: set font chu cho dong thu 1 con diapad
