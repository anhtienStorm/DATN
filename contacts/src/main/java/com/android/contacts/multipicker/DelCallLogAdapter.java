    ...
    public void onClick(View v) {
        ...
        if (clickId == R.id.photo_view) {
            if (details != null && details.mLookupUri != null) {
                ...
                // TODO Bkav TrungTH sua nhanh de fix loi crash, anhndd xem lai theo qui trinh customize
                ContactsFragment.showQuickContact(v, details.mLookupUri, mContext);
            }
