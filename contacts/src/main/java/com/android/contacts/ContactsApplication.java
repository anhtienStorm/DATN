...
public class ContactsApplication {
    ...
    public ContentResolver getContentResolver() {
        ...
        // Bkav Trungth: thay bo super di thay = null de check ben kia
    ...
    public void onCreate() {
        // Bkav Trungth: thay bo super di vi ko can nua mApplication vao
        ...
        // Bkav Trungth: thay gia mApplication vao
        AnalyticsUtil.initialize(mApplication);
    }
    ...
    private class DelayedInitializer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            // Bkav Trungth: thay gia mApplication vao
            final Context context = mApplication;
            ...
            context.getContentResolver().getType(ContentUris.withAppendedId(Contacts.CONTENT_URI, 1));
