...
public interface ContactInteraction {
    ...
    // Bkav HuyNQN Them ham getPathAudio
    @RequiresApi(api = Build.VERSION_CODES.N)
    default String getPathAudio() { return "";}

    // Bkav HuyNQN them lay ra gio thuc hien cuoc goi
    default String getCallHour(Context context){
        return "";
    }
}
