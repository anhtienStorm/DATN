...
import com.android.contacts.multipicker.CallLogQueryHandler;
...
public class CallLogInteraction implements ContactInteraction {
    ...
    // Bkav HuyNQN them ten cot record_call_data
    ...
    @Override
    public String getCallHour(Context context) {
        Long date = getDate();
        return date == null ? null : ContactInteractionUtil.formatHourStringFromTimestamp(
                date, context);
    }
    ...
    public Drawable getFooterIcon(Context context) {
        ...
        switch (type) {
            // Bkav HienDTk: set lai icon cho giao dien chi tiet lien he (dong nhat voi giao dien callog)
            case Calls.INCOMING_TYPE:
                callArrow = res.getDrawable(R.drawable.bkav_ic_incomming_call);
//                callArrow = res.getDrawable(CALL_ARROW_ICON_RES);
//                callArrow.setColorFilter(res.getColor(R.color.call_arrow_green),
//                        PorterDuff.Mode.MULTIPLY);
                break;
            case Calls.MISSED_TYPE:
                callArrow = res.getDrawable(R.drawable.bkav_ic_miss_call);
//                callArrow = res.getDrawable(CALL_ARROW_ICON_RES);
//                callArrow.setColorFilter(res.getColor(R.color.call_arrow_red),
//                        PorterDuff.Mode.MULTIPLY);
                break;
            case Calls.OUTGOING_TYPE:
                callArrow = res.getDrawable(R.drawable.bkav_ic_outgoing_call);
...
//                        PorterDuff.Mode.MULTIPLY);
    ...
    // Bkav HuyNQN
    public String getRecordCallData(){
        final String path=mValues.getAsString(RECORD_CALL_DATA);
        return path;
    }

    @Override
    public String getPathAudio() {
        return getRecordCallData();
    }
}
