...
public class CompactContactEditorFragment extends ContactEditorBaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        return view;*/
        //AnhNDd: custom
        return inflateCompactContactEditorFragment(inflater,container);
    }
    ...
    protected CompactContactEditorActivity getEditorActivity() {
        return (CompactContactEditorActivity) getActivity();
    }

    /*private*/protected CompactRawContactsEditorView getContent() {
        return (CompactRawContactsEditorView) mContent;
    }

    //======================BKAV========================

    //AnhNDd: tao fragment cua minh
    public View inflateCompactContactEditorFragment(LayoutInflater inflater, ViewGroup container){
        final View view = inflater.inflate(
                R.layout.compact_contact_editor_fragment, container, false);
        mContent = (LinearLayout) view.findViewById(R.id.raw_contacts_editor_view);
        return view;
