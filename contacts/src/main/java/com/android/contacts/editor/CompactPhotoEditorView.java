...
public class CompactPhotoEditorView extends RelativeLayout implements View.OnClickListener {
    ...
    protected View mPhotoIconOverlay;
    protected View mPhotoTouchInterceptOverlay;
    ...
    protected void adjustDimensions() {
...
//                    photoHeight = (int) (photoWidth / mPortraitPhotoRatio);
    ...
    protected void setDefaultPhoto(MaterialPalette materialPalette) {
        // EditorUiUtils.setDefaultPhoto(mPhotoImageView, getResources(), materialPalette);
        // Anhdts doi lai de lay tint
        EditorUiUtils.setDefaultPhoto(getResources(), mPhotoImageView, materialPalette);
    }
    ...
    /**
     * Anhdts get ra de set color filter
     */
    public QuickContactImageView getPhotoImageView() {
