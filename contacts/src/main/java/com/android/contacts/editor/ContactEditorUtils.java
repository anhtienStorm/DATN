...
public class ContactEditorUtils {
    ...
    private AccountWithDataSet getOverlayDefualtAccount() {
        ...
        /**
         * TrungTH
         * sua lai ten bool them config vao trong
         */
        if (mContext.getResources().getBoolean(com.android.contacts.R.bool.def_storage_behavior_enabled)) {
            ...
            if (accounts != null && accounts.size() != 0) {
                 ...
                 * sua lai ten bool them config vao trong
                 */
                int store_pos = mContext.getResources().getInteger(com.android.contacts.R.integer.def_storage_position);
                switch (store_pos) {
