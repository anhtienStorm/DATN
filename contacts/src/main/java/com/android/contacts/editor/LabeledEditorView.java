...
public abstract class LabeledEditorView extends LinearLayout implements Editor, DialogShowingView {
    ...
    protected RawContactDelta mState;
    ...
    protected OnItemSelectedListener mSpinnerListener = new OnItemSelectedListener() {
    ...
    protected void notifyEditorListener() {
        if (mListener != null) {
            // Bkav HienDTk: fix bug - BOS-2588 - start
            // Bkav HienDTk: sua lai logic khi nhap cac truong thi tu dong sinh ra cac truong moi
            mListener.onRequest(EditorListener.EDITOR_FOCUS_CHANGED);
            // Bkav HienDTk: fix bug - BOS-2588 - end
        }
