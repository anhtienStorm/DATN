...
public class PeopleActivity extends ContactsActivity implements
     ...
     */
    /*private*/protected MultiSelectContactsListFragment mAllFragment;
    ...
    private void createViewsAndFragments(Bundle savedState) {
        ...
        //AnhNDd: tách ra để custom lại
        findAllFragment(fragmentManager, ALL_TAG);
    ...
    /**
     * Adapter for the {@link ViewPager}.  Unlike {@link },
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == android.R.id.home) {
            ...
            //AnhNDd: thay code de custom
            startActivityContactsPreference();
            return true;
            ...
            return true;
        } else if (i == R.id.menu_add_group) {
            createNewGroup();
            return true;
        } else if (i == R.id.menu_delete) {
            deleteSelectedContacts();
            return true;
        } else if (i == R.id.menu_import_export) {
            showImportExportDialogFragment();
            return true;
            ...
            return true;
        } else if (i == R.id.export_database) {
...
//                break;
    ...
    /**
     * AnhNDd: thay code de start activity theo btalk
     */
