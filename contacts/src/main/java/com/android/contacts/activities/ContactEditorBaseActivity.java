...
abstract public class ContactEditorBaseActivity extends ContactsActivity
    ...
    public interface ContactEditor {
         ...
         * HuyNQn them bien codeSaveError de biet ro nguyen nhan loi khi luu tren sim
         */
    ...
    public void onCreate(Bundle savedState) {
        ...
        // Anhdts khong dung action bar, doi ve toolbar
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_EDIT.equals(action) || ACTION_EDIT.equals(action)) {
            ...
            mFragment.onSaveCompleted(true,
                    ...
                    intent.getIntExtra(ContactSaveService.CODE_SAVE_ERROR,0));
    ...
    protected final ContactEditorBaseFragment.Listener  mFragmentListener =
        ...
        public void onSaveFinished(Intent resultIntent) {
            if (mFinishActivityOnSaveCompleted) {
                ...
                // Bkav TienNAb: sua ham start activity
                ImplicitIntentsUtil.startActivityQuickContactInApp(ContactEditorBaseActivity.this,
                        resultIntent);
            }
            // Bkav TienNAb: fix loi khong hien thi giao dien chi tiet lien he khi them lien he moi
