...
public class ContactEditorAccountsChangedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numAccounts >= 2) {
            ...
            button.setVisibility(View.GONE);// Bkav HuyNQN khong cho nguoi dung them tai khoan moi nua

            mAccountListView = (ListView) view.findViewById(R.id.account_list);
            mAccountListAdapter = initAccountListAdapter();
            ...
            leftButton.setVisibility(View.GONE);// Bkav HuyNQN khong cho nguoi dung them tai khoan moi nua
            ...
            rightButton.setVisibility(View.GONE);// Bkav HuyNQN khong cho nguoi dung them tai khoan moi nua
        }
    ...
    protected AccountsListAdapter initAccountListAdapter() {
        return new AccountsListAdapter(this,
