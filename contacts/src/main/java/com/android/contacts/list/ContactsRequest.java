...
public class ContactsRequest {
    ...
    /** Anhdts convert number */
    public static final int ACTION_CONVERT_PHONE = 160;

    /** Bkav TienNAb them action add favorite list */
    public static final int ACTION_ADD_FAVORITE_CONTACT_LIST = 170;
