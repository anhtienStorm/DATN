...
public class MultiSelectContactsListFragment extends DefaultContactBrowseListFragment
    ...
    protected boolean onItemLongClick(int position, long id) {
        ...
        if (uri != null && (partition == ContactsContract.Directory.DEFAULT
                && (/*position > 0*//*AnhNDd: custom*/isNotPositionProfile(position) || !getAdapter().hasProfile()))) {
    ...
    protected ContactListAdapter createListAdapter() {
        ...
        DefaultContactListAdapter adapter = createMultiSelectEntryContactListAdapter(getContext());
    ...
    public DefaultContactListAdapter createMultiSelectEntryContactListAdapter(Context context) {
        return new MultiSelectEntryContactListAdapter(getContext());
    }
