...
public class PostalAddressListAdapter extends ContactEntryListAdapter {
    ...
    protected static class PostalQuery {
        private static final String[] PROJECTION_PRIMARY = !PermissionsUtil.isAndroidQ() ?
                new String[] {
...
//            RawContacts.ACCOUNT_NAME                    // 8
        ...
        private static final String[] PROJECTION_ALTERNATIVE = !PermissionsUtil.isAndroidQ() ?
                new String[] {
            StructuredPostal._ID,                       // 0
            StructuredPostal.TYPE,                      // 1
            StructuredPostal.LABEL,                     // 2
