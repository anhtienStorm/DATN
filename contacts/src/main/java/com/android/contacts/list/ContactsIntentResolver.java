...
public class ContactsIntentResolver {
    ...
    public ContactsRequest resolveIntent(Intent intent) {
        ...
        if (UiIntentActions.LIST_DEFAULT.equals(action) ) {
            ...
            // Bkav TienNAb: check xem co phai la intent add favorite khong
            if (intent.getStringExtra(ACTION) != null) {
                if (intent.getStringExtra(ACTION).equals(ACTION_ADD_FAVORITE)){
                    request.setActionCode(ContactsRequest.ACTION_ADD_FAVORITE_CONTACT_LIST);
                }
            } else {
        ...
        // Anhdts action convert phone
        else if (UiIntentActions.CONVERT_PHONE_ACTION.equals(action)) {
            request.setActionCode(ContactsRequest.ACTION_CONVERT_PHONE);
            request.setSearchMode(false);
        }
