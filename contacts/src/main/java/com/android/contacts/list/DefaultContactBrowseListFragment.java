...
public class DefaultContactBrowseListFragment extends ContactBrowseListFragment {
    ...
    /*private*/protected View mAccountFilterHeader;
    ...
    protected void onItemClick(int position, long id) {
        ...
        viewContactAndCall(uri, getAdapter().isEnterpriseContact(position));
    }
    ...
    /*private*/protected void updateFilterHeaderView() {
    ...
    protected void setProfileHeader() {
        ...
        //AnhNDd: thay code để custom
        shouldShowEmptyUserProfile(!mUserProfileExists && !isSearchMode());
    ...
    //===================Bkav=======================
    //AnhNDd: Thay đổi điều kiện kiểm tra xem có hiển thị view profile hay không.
    public void shouldShowEmptyUserProfile(boolean bool) {
        showEmptyUserProfile(bool);
    }

    /**
     * AnhNDd: Hàm thực hiện việc hiển thị các số của contact và gọi nếu chỉ có 1 số.
     * @param contactLookupUri
     * @param isEnterpriseContact
     */
    public void viewContactAndCall(Uri contactLookupUri, boolean isEnterpriseContact) {
        viewContact(contactLookupUri, isEnterpriseContact);
    }
}
